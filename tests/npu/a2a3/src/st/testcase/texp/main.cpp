...
TEST_F(TEXPTest, case_float_64x64_64x64_64x64_inPlace_True) { test_texp<float, 64, 64, 64, 64, true>(); }
TEST_F(TEXPTest, case_float_64x64_64x64_64x64_inPlace_False) { test_texp<float, 64, 64, 64, 64, false>(); }
TEST_F(TEXPTest, case_half_64x64_64x64_64x64_inPlace_True) { test_texp<aclFloat16, 64, 64, 64, 64, true>(); }
TEST_F(TEXPTest, case_half_64x64_64x64_64x64_inPlace_False) { test_texp<aclFloat16, 64, 64, 64, 64, false>(); }
