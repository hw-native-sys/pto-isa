...
__global__ AICORE void runTPartArgMax(
    __gm__ TVal __out__* dstVal, __gm__ TIdx __out__* dstIdx, __gm__ TVal __out__* src0Val,
    __gm__ TIdx __out__* src0Idx, __gm__ TVal __out__* src1Val, __gm__ TIdx __out__* src1Idx)
{
    ...
    TPARTARGMAX(dstValTile, src0ValTile, src1ValTile, dstIdxTile, src0IdxTile, src1IdxTile);
...
{
    runTPartArgMax<
        TVal, TIdx, dstValH, dstValW, dstIdxH, dstIdxW, src0ValH, src0ValW, src0IdxH, src0IdxW, src1ValH, src1ValW,
...
template <
    ...
    int vCols1>
void LaunchTPartArgMaxHalf(
    aclFloat16* outVal, TIdx* outIdx, aclFloat16* src0Val, TIdx* src0Idx, aclFloat16* src1Val, TIdx* src1Idx,
    void* stream)
{
    runTPartArgMax<
        half, TIdx, dstValH, dstValW, dstIdxH, dstIdxW, src0ValH, src0ValW, src0IdxH, src0IdxW, src1ValH, src1ValW,
        src1IdxH, src1IdxW, vRows0, vCols0, vRows1, vCols1>
        <<<1, nullptr, stream>>>((half*)outVal, outIdx, (half*)src0Val, src0Idx, (half*)src1Val, src1Idx);
}

template void LaunchTPartArgMax<float, uint32_t, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 3, 8, 4, 8>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 3, 8>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 7, 4, 8>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 7>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 3, 7, 4, 8>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 3, 7>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 7, 4, 7>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 3, 7, 4, 7>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 7, 3, 7>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 5, 4, 7>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 7, 4, 5>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMax<float, uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMax<float, uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 111, 64, 128, 64>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMax<float, uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 111, 64>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMax<float, uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 57, 128, 64>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMax<float, uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 57>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMax<float, uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 111, 57, 128, 64>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMax<float, uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 111, 57>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMaxHalf<uint16_t, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128>(
    aclFloat16* outVal, uint16_t* outIdx, aclFloat16* src0Val, uint16_t* src0Idx, aclFloat16* src1Val,
    uint16_t* src1Idx, void* stream);
template void
LaunchTPartArgMaxHalf<uint16_t, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 111, 128, 128, 128>(
    aclFloat16* outVal, uint16_t* outIdx, aclFloat16* src0Val, uint16_t* src0Idx, aclFloat16* src1Val,
    uint16_t* src1Idx, void* stream);
template void
LaunchTPartArgMaxHalf<uint16_t, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 111, 128>(
    aclFloat16* outVal, uint16_t* outIdx, aclFloat16* src0Val, uint16_t* src0Idx, aclFloat16* src1Val,
    uint16_t* src1Idx, void* stream);
template void
LaunchTPartArgMaxHalf<uint16_t, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 111, 128, 128>(
    aclFloat16* outVal, uint16_t* outIdx, aclFloat16* src0Val, uint16_t* src0Idx, aclFloat16* src1Val,
    uint16_t* src1Idx, void* stream);
template void
LaunchTPartArgMaxHalf<uint16_t, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 111>(
    aclFloat16* outVal, uint16_t* outIdx, aclFloat16* src0Val, uint16_t* src0Idx, aclFloat16* src1Val,
    uint16_t* src1Idx, void* stream);
template void LaunchTPartArgMax<float, uint32_t, 4, 8, 4, 16, 4, 24, 4, 32, 4, 40, 4, 48, 4, 7, 4, 7>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 57, 128, 57, 120, 57, 112, 57, 104, 57, 144, 57, 136, 57, 97, 57, 97>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 57, 128, 57, 120, 51, 112, 51, 104, 57, 144, 57, 136, 51, 97, 57, 97>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 57, 128, 57, 120, 57, 112, 57, 104, 51, 144, 51, 136, 57, 97, 51, 97>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 57, 128, 57, 120, 57, 112, 57, 104, 57, 144, 57, 136, 57, 97, 57, 101>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 57, 128, 57, 120, 57, 112, 57, 104, 57, 144, 57, 136, 57, 101, 57, 97>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMax<float, uint32_t, 57, 128, 57, 120, 57, 112, 57, 104, 57, 144, 57, 136, 51, 97, 57, 101>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
