...
void launchTExtractVecND(uint8_t* out, uint8_t* srcIn, uint8_t* dstInitIn, void* stream)
{
    if constexpr (testKey == 1) {
        ...
        RunTExtractNDVec<bfloat16_t, 32, 64, 16, 32, 16, 32, 8, 32>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
        ...
        RunTExtractNDVec<bfloat16_t, 24, 48, 12, 32, 6, 16, 11, 16>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
        ...
        RunTExtractNDVec<bfloat16_t, 32, 32, 8, 16, 8, 14, 0, 0>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
...
void launchTExtractVecNZ(uint8_t* out, uint8_t* srcIn, uint8_t* dstInitIn, void* stream)
{
    if constexpr (testKey == 1) {
        ...
        RunTExtractNZVec<bfloat16_t, 32, 32, 16, 32, 0, 0, 16, 16>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
    } else if constexpr (testKey == 10) {
        ...
        RunTExtractNZVec<bfloat16_t, 64, 64, 32, 32, 32, 32, 16, 16>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
    } else if constexpr (testKey == 18) {
        ...
        RunTExtractNZVec<bfloat16_t, 48, 48, 32, 32, 16, 16, 16, 16>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
    } else if constexpr (testKey == 21) {
        ...
        RunTExtractNZVec<bfloat16_t, 32, 32, 16, 32, 0, 0, 16, 10>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
    } else if constexpr (testKey == 25) {
        ...
        RunTExtractNZVec<bfloat16_t, 32, 32, 16, 32, 16, 16, 10, 10>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
    }
}
