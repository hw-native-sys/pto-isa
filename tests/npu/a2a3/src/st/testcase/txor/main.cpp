...
void test_txor()
{
    ...
    LaunchTXor<T, dstTileH, dstTileW, src0TileH, src0TileW, src1TileH, src1TileW, vRows, vCols>(
...
TEST_F(TXORTest, case_int16_64x64_64x64_64x64_64x64) { test_txor<int16_t, 64, 64, 64, 64, 64, 64, 64, 64>(); }
TEST_F(TXORTest, case_int16_32x128_32x128_32x256_32x128) { test_txor<int16_t, 32, 128, 32, 128, 32, 256, 32, 128>(); }
TEST_F(TXORTest, case_int16_32x128_32x128_32x256_32x127) { test_txor<int16_t, 32, 128, 32, 128, 32, 256, 32, 127>(); }
TEST_F(TXORTest, case_uint16_64x64_64x64_64x64_64x64) { test_txor<uint16_t, 64, 64, 64, 64, 64, 64, 64, 64>(); }
TEST_F(TXORTest, case_uint16_32x128_32x128_32x256_32x128) { test_txor<uint16_t, 32, 128, 32, 128, 32, 256, 32, 128>(); }
TEST_F(TXORTest, case_uint16_32x128_32x128_32x256_32x127) { test_txor<uint16_t, 32, 128, 32, 128, 32, 256, 32, 127>(); }
TEST_F(TXORTest, case_int8_32x128_32x128_32x256_32x127) { test_txor<int8_t, 32, 128, 32, 128, 32, 256, 32, 127>(); }
TEST_F(TXORTest, case_uint8_32x128_32x128_32x256_32x127) { test_txor<uint8_t, 32, 128, 32, 128, 32, 256, 32, 127>(); }
TEST_F(TXORTest, case_int32_32x128_32x128_32x256_32x127) { test_txor<int32_t, 32, 128, 32, 128, 32, 256, 32, 127>(); }
TEST_F(TXORTest, case_uint32_32x128_32x128_32x256_32x127) { test_txor<uint32_t, 32, 128, 32, 128, 32, 256, 32, 127>(); }
