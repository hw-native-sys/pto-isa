...
TEST_F(TPRELUTest, case1) { test_tshl<aclFloat16, 64, 64, 64, 64>(); }

TEST_F(TPRELUTest, case2) { test_tshl<aclFloat16, 64, 64, 63, 63>(); }

TEST_F(TPRELUTest, case3) { test_tshl<aclFloat16, 1, 16384, 1, 16384>(); }

TEST_F(TPRELUTest, case4) { test_tshl<aclFloat16, 1024, 16, 1024, 16>(); }

TEST_F(TPRELUTest, case5) { test_tshl<float, 64, 64, 64, 64>(); }

TEST_F(TPRELUTest, case6) { test_tshl<float, 64, 64, 63, 63>(); }

TEST_F(TPRELUTest, case7) { test_tshl<float, 1, 8192, 1, 8192>(); }

TEST_F(TPRELUTest, case8) { test_tshl<float, 1024, 8, 1024, 8>(); }