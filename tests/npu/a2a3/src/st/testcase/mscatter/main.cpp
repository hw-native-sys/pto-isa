...
DECLARE_LAUNCH(row_half_skip_8x32_8rows, aclFloat16, int32_t)

DECLARE_LAUNCH(row_float_atomic_add_8x32_8rows, float, int32_t)
DECLARE_LAUNCH(row_int32_atomic_add_8x16_8rows, int32_t, int32_t)
DECLARE_LAUNCH(row_half_atomic_add_8x32_8rows, aclFloat16, int32_t)
DECLARE_LAUNCH(row_int16_atomic_add_8x16_8rows, int16_t, int32_t)
DECLARE_LAUNCH(row_bfloat16_atomic_add_8x32_8rows, uint16_t, int32_t)
DECLARE_LAUNCH(row_bfloat16_atomic_add_16x16_16rows, uint16_t, int32_t)
DECLARE_LAUNCH(row_bfloat16_atomic_add_8x64_16rows, uint16_t, int32_t)
...
DECLARE_LAUNCH(elem_half_skip_32_16size, aclFloat16, int32_t)
...
DECLARE_LAUNCH(elem2d_half_skip_4x32_64size, aclFloat16, int32_t)
...
DECLARE_LAUNCH(elem2d_float_atomic_add_4x16_8size, float, int32_t)
DECLARE_LAUNCH(elem2d_int32_atomic_add_4x8_8size, int32_t, int32_t)
DECLARE_LAUNCH(elem2d_half_atomic_add_4x16_8size, aclFloat16, int32_t)
DECLARE_LAUNCH(elem2d_bfloat16_atomic_add_4x16_8size, uint16_t, int32_t)
DECLARE_LAUNCH(elem2d_bfloat16_atomic_add_8x16_64size, uint16_t, int32_t)
DECLARE_LAUNCH(elem_int32_atomic_add_16_8size, int32_t, int32_t)
DECLARE_LAUNCH(elem_bfloat16_atomic_add_32_16size, uint16_t, int32_t)
...
DECLARE_LAUNCH(row_nz_float_atomic_add_16x8_1blk, float, int32_t)
...
#define SCALAR_TEST(NAME, THOST, TIDX, TS)                                               \
    TEST_F(MSCATTERTest, case_##NAME)                                                    \
    {                                                                                    \
        run_mscatter_test<THOST, TIDX>((size_t)1, (size_t)1, (size_t)TS, Launch_##NAME); \
    }
...
ROW_TEST(row_half_skip_8x32_8rows, aclFloat16, int32_t, 8, 32, 8)

ROW_TEST(row_float_atomic_add_8x32_8rows, float, int32_t, 8, 32, 8)
ROW_TEST(row_int32_atomic_add_8x16_8rows, int32_t, int32_t, 8, 16, 8)
ROW_TEST(row_half_atomic_add_8x32_8rows, aclFloat16, int32_t, 8, 32, 8)
ROW_TEST(row_int16_atomic_add_8x16_8rows, int16_t, int32_t, 8, 16, 8)
ROW_TEST(row_bfloat16_atomic_add_8x32_8rows, uint16_t, int32_t, 8, 32, 8)
ROW_TEST(row_bfloat16_atomic_add_16x16_16rows, uint16_t, int32_t, 16, 16, 16)
ROW_TEST(row_bfloat16_atomic_add_8x64_16rows, uint16_t, int32_t, 8, 64, 16)
...
ELEM_TEST(elem_half_skip_32_16size, aclFloat16, int32_t, 32, 16)
...
ELEM2D_TEST(elem2d_half_skip_4x32_64size, aclFloat16, int32_t, 4, 32, 64)
...
ELEM2D_TEST(elem2d_float_atomic_add_4x16_8size, float, int32_t, 4, 16, 8)
ELEM2D_TEST(elem2d_int32_atomic_add_4x8_8size, int32_t, int32_t, 4, 8, 8)
ELEM2D_TEST(elem2d_half_atomic_add_4x16_8size, aclFloat16, int32_t, 4, 16, 8)
ELEM2D_TEST(elem2d_bfloat16_atomic_add_4x16_8size, uint16_t, int32_t, 4, 16, 8)
ELEM2D_TEST(elem2d_bfloat16_atomic_add_8x16_64size, uint16_t, int32_t, 8, 16, 64)
ELEM_TEST(elem_int32_atomic_add_16_8size, int32_t, int32_t, 16, 8)
ELEM_TEST(elem_bfloat16_atomic_add_32_16size, uint16_t, int32_t, 32, 16)
...
#define ELEM2D_DYN_TEST(NAME, THOST, TIDX, RVR, RVC, RTS)                                                 \
    TEST_F(MSCATTERTest, case_##NAME)                                                                     \
    {                                                                                                     \
        run_mscatter_test<THOST, TIDX>((size_t)RVR * RVC, (size_t)RVR * RVC, (size_t)RTS, Launch_##NAME); \
    }
...
#define ROW_NZ_TEST(NAME, THOST, TIDX, R, C, BR, BC, C0)                                                    \
    TEST_F(MSCATTERTest, case_##NAME)                                                                       \
    {                                                                                                       \
        run_mscatter_test<THOST, TIDX>((size_t)R * C, (size_t)R, (size_t)BR * 16 * BC * C0, Launch_##NAME); \
    }

#define ELEM2D_NZ_TEST(NAME, THOST, TIDX, R, C, BR, BC, C0)                                                     \
    TEST_F(MSCATTERTest, case_##NAME)                                                                           \
    {                                                                                                           \
        run_mscatter_test<THOST, TIDX>((size_t)R * C, (size_t)R * C, (size_t)BR * 16 * BC * C0, Launch_##NAME); \
    }
...
ROW_NZ_TEST(row_nz_float_atomic_add_16x8_1blk, float, int32_t, 16, 8, 2, 1, 8)
