...
template <
    typename T, uint32_t SrcStaticRows, uint32_t SrcStaticCols, uint32_t DstStaticRows, uint32_t DstStaticCols,
...
__global__ AICORE void RunTInsertNDVec(__gm__ T* out, __gm__ T* srcIn, __gm__ T* dstInitIn)
{
    ...
    using SrcStride = pto::Stride<
        SrcStaticRows * SrcStaticCols, SrcStaticRows * SrcStaticCols, SrcStaticRows * SrcStaticCols, SrcStaticCols, 1>;
...
template <
    typename T, uint32_t SrcRows, uint32_t SrcCols, uint32_t DstRows, uint32_t DstCols, uint32_t SrcValidRows,
...
void launchTInsertVecND(uint8_t* out, uint8_t* srcIn, uint8_t* dstInitIn, void* stream)
{
    if constexpr (testKey == 1) {
        ...
        RunTInsertNDVec<bfloat16_t, 16, 16, 32, 32, 16, 16, 0, 16>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
        ...
        RunTInsertNDVec<bfloat16_t, 16, 32, 32, 64, 16, 32, 8, 32>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
        ...
        RunTInsertNDVec<bfloat16_t, 12, 32, 24, 48, 6, 16, 11, 16>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
        ...
        RunTInsertNDVec<bfloat16_t, 8, 16, 32, 32, 8, 14, 0, 0>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
...
void launchTInsertVecNDScalar(uint8_t* out, uint8_t* srcIn, uint8_t* dstInitIn, void* stream)
{
    if constexpr (testKey == 1) {
        ...
        RunTInsertNDVecScalar<bfloat16_t, 32, 32, 3, 11>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
    } else if constexpr (testKey == 4) {
...
void launchTInsertVecNZ(uint8_t* out, uint8_t* srcIn, uint8_t* dstInitIn, void* stream)
{
    if constexpr (testKey == 1) {
        ...
        RunTInsertNZVec<bfloat16_t, 16, 32, 32, 32, 16, 32, 16, 0>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
    } else if constexpr (testKey == 5) {
        ...
        RunTInsertNZVec<bfloat16_t, 16, 32, 32, 32, 16, 16, 0, 0>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
    } else if constexpr (testKey == 10) {
        ...
        RunTInsertNZVec<bfloat16_t, 32, 32, 64, 64, 16, 16, 32, 32>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
    } else if constexpr (testKey == 18) {
        ...
        RunTInsertNZVec<bfloat16_t, 32, 32, 48, 48, 16, 16, 16, 16>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
    } else if constexpr (testKey == 21) {
        ...
        RunTInsertNZVec<bfloat16_t, 16, 32, 32, 32, 16, 10, 0, 0>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
    } else if constexpr (testKey == 25) {
        ...
        RunTInsertNZVec<bfloat16_t, 16, 32, 32, 32, 10, 10, 16, 16>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
    }
}
...
void launchTInsertVecNZScalar(uint8_t* out, uint8_t* srcIn, uint8_t* dstInitIn, void* stream)
{
    if constexpr (testKey == 1) {
        ...
        RunTInsertNZVecScalar<bfloat16_t, 16, 16, 32, 32, 11, 3>
            <<<1, nullptr, stream>>>((__gm__ bfloat16_t*)out, (__gm__ bfloat16_t*)srcIn, (__gm__ bfloat16_t*)dstInitIn);
    } else if constexpr (testKey == 4) {
