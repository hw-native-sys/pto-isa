...
template void LaunchTOrS<uint16_t, 32, 128, 32, 128, 32, 128>(
    uint16_t* out, uint16_t* src, uint16_t scalar, void* stream);
template void LaunchTOrS<uint16_t, 32, 112, 32, 128, 32, 111>(
    uint16_t* out, uint16_t* src, uint16_t scalar, void* stream);
...
template void LaunchTOrS<uint32_t, 32, 128, 32, 128, 32, 128>(
    uint32_t* out, uint32_t* src, uint32_t scalar, void* stream);
template void LaunchTOrS<uint32_t, 32, 112, 32, 128, 32, 111>(
    uint32_t* out, uint32_t* src, uint32_t scalar, void* stream);
