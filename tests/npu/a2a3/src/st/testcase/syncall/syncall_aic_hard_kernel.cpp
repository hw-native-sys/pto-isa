...
extern "C" __global__ AICORE void RunHardSyncAllAIC_2001(__gm__ uint64_t __in__ *fftsAddr, __gm__ int32_t __out__ *out,
...
{
    RunHardSyncAllAIC_2001<<<launchBlocks, nullptr, stream>>>(reinterpret_cast<uint64_t *>(ffts), out, flags,
                                                              launchBlocks);
}
