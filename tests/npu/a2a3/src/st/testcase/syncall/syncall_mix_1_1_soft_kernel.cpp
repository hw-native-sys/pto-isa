...
extern "C" __global__ AICORE void RunSoftSyncAllMix11_1102_mix_aiv(
...
extern "C" __global__ AICORE void RunSoftSyncAllMix11_1102_mix_aic(
    __gm__ uint64_t __in__* fftsAddr, __gm__ int32_t __out__* out, __gm__ int32_t __out__* flags,
    __gm__ int32_t __out__* syncWorkspace, int32_t aicBlocks, int32_t totalParticipants)
{
    ...
    void* stream)
{
    ...
    RunSoftSyncAllMix11_1102_mix_aic<<<aicBlocks, nullptr, stream>>>(
        reinterpret_cast<uint64_t*>(ffts), out, flags, syncWorkspace, aicBlocks, totalParticipants);
    RunSoftSyncAllMix11_1102_mix_aiv<<<aicBlocks, nullptr, aivStream>>>(
        reinterpret_cast<uint64_t*>(ffts), out, flags, syncWorkspace, aicBlocks, totalParticipants);
