...
// totalBlocks is the number of cores that reach the barrier, which is also how many
// flag slots each participant is expected to observe.
...
// Partial participation: every AIV core is launched, but only blocks [0, syncBlocks)
