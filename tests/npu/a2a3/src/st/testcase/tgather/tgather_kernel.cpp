...
template void
LaunchTGATHER<uint16_t, HALF_P0101_ROW, HALF_P0101_COL, HALF_P0101_ROW, HALF_P0101_COL, MaskPattern::P0101>(
    uint16_t* out, uint16_t* src, void* stream);

template void
LaunchTGATHER<uint16_t, HALF_P1010_ROW, HALF_P1010_COL, HALF_P1010_ROW, HALF_P1010_COL, MaskPattern::P1010>(
    uint16_t* out, uint16_t* src, void* stream);

template void
LaunchTGATHER<int16_t, HALF_P0001_ROW, HALF_P0001_COL, HALF_P0001_ROW, HALF_P0001_COL, MaskPattern::P0001>(
    int16_t* out, int16_t* src, void* stream);

template void
LaunchTGATHER<int16_t, HALF_P0010_ROW, HALF_P0010_COL, HALF_P0010_ROW, HALF_P0010_COL, MaskPattern::P0010>(
    int16_t* out, int16_t* src, void* stream);

template void
LaunchTGATHER<uint32_t, FLOAT_P0100_ROW, FLOAT_P0100_COL, FLOAT_P0100_ROW, FLOAT_P0100_COL, MaskPattern::P0100>(
    uint32_t* out, uint32_t* src, void* stream);

template void
LaunchTGATHER<int32_t, FLOAT_P1000_ROW, FLOAT_P1000_COL, FLOAT_P1000_ROW, FLOAT_P1000_COL, MaskPattern::P1000>(
    int32_t* out, int32_t* src, void* stream);

template void
LaunchTGATHER<int32_t, FLOAT_P1111_ROW, FLOAT_P1111_COL, FLOAT_P1111_ROW, FLOAT_P1111_COL, MaskPattern::P1111>(
    int32_t* out, int32_t* src, void* stream);
...
template void
LaunchTGATHER<uint16_t, HALF_P0001_ROW, HALF_P0001_COL, HALF_P0001_ROW, HALF_P0001_COL, MaskPattern::P0001>(
    uint16_t* out, uint16_t* src, void* stream);

template void
LaunchTGATHER<uint16_t, HALF_P0010_ROW, HALF_P0010_COL, HALF_P0010_ROW, HALF_P0010_COL, MaskPattern::P0010>(
    uint16_t* out, uint16_t* src, void* stream);

template void
LaunchTGATHER<uint16_t, HALF_P0100_ROW, HALF_P0100_COL, HALF_P0100_ROW, HALF_P0100_COL, MaskPattern::P0100>(
    uint16_t* out, uint16_t* src, void* stream);

template void
LaunchTGATHER<uint16_t, HALF_P1000_ROW, HALF_P1000_COL, HALF_P1000_ROW, HALF_P1000_COL, MaskPattern::P1000>(
    uint16_t* out, uint16_t* src, void* stream);

template void
LaunchTGATHER<uint16_t, HALF_P1111_ROW, HALF_P1111_COL, HALF_P1111_ROW, HALF_P1111_COL, MaskPattern::P1111>(
    uint16_t* out, uint16_t* src, void* stream);

template void
LaunchTGATHER<float, FLOAT_P0101_ROW, FLOAT_P0101_COL, FLOAT_P0101_ROW, FLOAT_P0101_COL, MaskPattern::P0101>(
    float* out, float* src, void* stream);

template void
LaunchTGATHER<float, FLOAT_P1010_ROW, FLOAT_P1010_COL, FLOAT_P1010_ROW, FLOAT_P1010_COL, MaskPattern::P1010>(
    float* out, float* src, void* stream);

template void
LaunchTGATHER<float, FLOAT_P0001_ROW, FLOAT_P0001_COL, FLOAT_P0001_ROW, FLOAT_P0001_COL, MaskPattern::P0001>(
    float* out, float* src, void* stream);

template void
LaunchTGATHER<float, FLOAT_P0010_ROW, FLOAT_P0010_COL, FLOAT_P0010_ROW, FLOAT_P0010_COL, MaskPattern::P0010>(
    float* out, float* src, void* stream);

template void
LaunchTGATHER<float, FLOAT_P0100_ROW, FLOAT_P0100_COL, FLOAT_P0100_ROW, FLOAT_P0100_COL, MaskPattern::P0100>(
    float* out, float* src, void* stream);

template void
LaunchTGATHER<float, FLOAT_P1000_ROW, FLOAT_P1000_COL, FLOAT_P1000_ROW, FLOAT_P1000_COL, MaskPattern::P1000>(
    float* out, float* src, void* stream);

template void
LaunchTGATHER<float, FLOAT_P1111_ROW, FLOAT_P1111_COL, FLOAT_P1111_ROW, FLOAT_P1111_COL, MaskPattern::P1111>(
    float* out, float* src, void* stream);
...
template void launchTGATHER_demo<int16_t, int32_t, int16_t, 16, 1024, 16, 128>(
    int16_t* src0, int32_t* src1, int16_t* out, void* stream);
template void launchTGATHER_demo<int16_t, int32_t, int16_t, 32, 256, 32, 64>(
    int16_t* src0, int32_t* src1, int16_t* out, void* stream);
template void launchTGATHER_demo<int16_t, int32_t, int16_t, 1, 16, 1, 16>(
    int16_t* src0, int32_t* src1, int16_t* out, void* stream);
template void launchTGATHER_demo<int16_t, int32_t, int16_t, 1, 32, 1, 32>(
    int16_t* src0, int32_t* src1, int16_t* out, void* stream);
template void launchTGATHER_demo<int16_t, int32_t, int16_t, 1, 64, 1, 64>(
    int16_t* src0, int32_t* src1, int16_t* out, void* stream);
template void launchTGATHER_demo<int16_t, int32_t, int16_t, 1, 128, 1, 128>(
    int16_t* src0, int32_t* src1, int16_t* out, void* stream);
template void launchTGATHER_demo<int16_t, int32_t, int16_t, 1, 128, 1, 64>(
    int16_t* src0, int32_t* src1, int16_t* out, void* stream);
template void launchTGATHER_demo<float, int32_t, float, 1024, 16, 1024, 16>(
    float* src0, int32_t* src1, float* out, void* stream);
template void launchTGATHER_demo<float, int32_t, float, 16, 16, 32, 32>(
    float* src0, int32_t* src1, float* out, void* stream);
template void launchTGATHER_demo<int16_t, int32_t, int16_t, 16, 16, 32, 32>(
    int16_t* src0, int32_t* src1, int16_t* out, void* stream);
