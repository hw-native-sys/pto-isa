...
TEST_F(TROWARGMINTest, case_uint32_float_8x1_8x8_1x8_8x8) { this->Launch<uint32_t, float, 8, 1, 8, 8, 1, 8, 8, 8>(); }
...
TEST_F(TROWARGMINTest, case_uint32_half_16x1_16x1_2x4096_2x1536_2x4096)
{
    this->Launch<uint32_t, aclFloat16, 16, 1, 16, 1, 2, 4096, 2, 1536, 2, 4096, true>();
}
TEST_F(TROWARGMINTest, case_uint32_half_16x1_16x1_1x65552_1x1536_1x65552)
{
    this->Launch<uint32_t, aclFloat16, 16, 1, 16, 1, 1, 65552, 1, 1536, 1, 65552, true>();
}
TEST_F(TROWARGMINTest, case_uint32_half_272x1_272x1_272x112_272x16_272x112)
{
    this->Launch<uint32_t, aclFloat16, 272, 1, 272, 1, 272, 112, 272, 16, 272, 112, true>();
}
TEST_F(TROWARGMINTest, case_uint32_half_272x16_272x8_272x112_272x16_272x112)
{
