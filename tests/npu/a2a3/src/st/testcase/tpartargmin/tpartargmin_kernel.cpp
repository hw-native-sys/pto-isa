...
__global__ AICORE void runTPartArgMin(
...
template void LaunchTPartArgMin<float, uint32_t, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 7, 4, 5>(
    ...
    void* stream);
template void
LaunchTPartArgMin<float, uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMin<float, uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 111, 64, 128, 64>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMin<float, uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 111, 64>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMin<float, uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 57, 128, 64>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMin<float, uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 57>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMin<float, uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 111, 57, 128, 64>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMin<float, uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 111, 57>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void
LaunchTPartArgMinHalf<uint16_t, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128>(
    aclFloat16* outVal, uint16_t* outIdx, aclFloat16* src0Val, uint16_t* src0Idx, aclFloat16* src1Val,
    uint16_t* src1Idx, void* stream);
template void
LaunchTPartArgMinHalf<uint16_t, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 111, 128, 128, 128>(
    aclFloat16* outVal, uint16_t* outIdx, aclFloat16* src0Val, uint16_t* src0Idx, aclFloat16* src1Val,
    uint16_t* src1Idx, void* stream);
template void
LaunchTPartArgMinHalf<uint16_t, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 111, 128>(
    aclFloat16* outVal, uint16_t* outIdx, aclFloat16* src0Val, uint16_t* src0Idx, aclFloat16* src1Val,
    uint16_t* src1Idx, void* stream);
template void
LaunchTPartArgMinHalf<uint16_t, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 111, 128, 128>(
    aclFloat16* outVal, uint16_t* outIdx, aclFloat16* src0Val, uint16_t* src0Idx, aclFloat16* src1Val,
    uint16_t* src1Idx, void* stream);
template void
LaunchTPartArgMinHalf<uint16_t, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 111>(
    aclFloat16* outVal, uint16_t* outIdx, aclFloat16* src0Val, uint16_t* src0Idx, aclFloat16* src1Val,
    uint16_t* src1Idx, void* stream);
...
template void LaunchTPartArgMin<float, uint32_t, 57, 128, 57, 120, 57, 112, 57, 104, 57, 144, 57, 136, 57, 101, 51, 97>(
    float* outVal, uint32_t* outIdx, float* src0Val, uint32_t* src0Idx, float* src1Val, uint32_t* src1Idx,
    void* stream);
template void LaunchTPartArgMinHalf<uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64>(
    aclFloat16* outVal, uint32_t* outIdx, aclFloat16* src0Val, uint32_t* src0Idx, aclFloat16* src1Val,
    uint32_t* src1Idx, void* stream);
template void LaunchTPartArgMinHalf<uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 111, 64, 128, 64>(
    aclFloat16* outVal, uint32_t* outIdx, aclFloat16* src0Val, uint32_t* src0Idx, aclFloat16* src1Val,
    uint32_t* src1Idx, void* stream);
template void LaunchTPartArgMinHalf<uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 111, 64>(
    aclFloat16* outVal, uint32_t* outIdx, aclFloat16* src0Val, uint32_t* src0Idx, aclFloat16* src1Val,
    uint32_t* src1Idx, void* stream);
template void LaunchTPartArgMinHalf<uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 57, 128, 64>(
    aclFloat16* outVal, uint32_t* outIdx, aclFloat16* src0Val, uint32_t* src0Idx, aclFloat16* src1Val,
    uint32_t* src1Idx, void* stream);
template void LaunchTPartArgMinHalf<uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 57>(
    aclFloat16* outVal, uint32_t* outIdx, aclFloat16* src0Val, uint32_t* src0Idx, aclFloat16* src1Val,
    uint32_t* src1Idx, void* stream);
template void LaunchTPartArgMinHalf<uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 111, 57, 128, 64>(
    aclFloat16* outVal, uint32_t* outIdx, aclFloat16* src0Val, uint32_t* src0Idx, aclFloat16* src1Val,
    uint32_t* src1Idx, void* stream);
template void LaunchTPartArgMinHalf<uint32_t, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 111, 57>(
    aclFloat16* outVal, uint32_t* outIdx, aclFloat16* src0Val, uint32_t* src0Idx, aclFloat16* src1Val,
    uint32_t* src1Idx, void* stream);
