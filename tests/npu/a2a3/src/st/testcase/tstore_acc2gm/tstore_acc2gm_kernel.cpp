...
template <
    ...
    int dstH, int dstW, int gWholeShape0, int gWholeShape1, int gWholeShape2, int gWholeShape3, int gWholeShape4,
    int validM, int validN, int validK, int reluMode = 0>
__global__ AICORE void TStoreAcc2gmNz2NDC1HWC0(
    __gm__ dstDataType* out, __gm__ srcDataType* src0, __gm__ srcDataType* src1)
{
    constexpr int dstC0 = std::is_same_v<dstDataType, int32_t> ? 16 : 32 / sizeof(dstDataType);
    constexpr int gStride[5] = {
        gWholeShape1 * gWholeShape2 * gWholeShape3 * gWholeShape4 * dstC0,
        gWholeShape2 * gWholeShape3 * gWholeShape4 * dstC0, gWholeShape3 * gWholeShape4 * dstC0, gWholeShape4 * dstC0,
        dstC0};
...
template <
    ...
    int dstH, int dstW, int gWholeShape0, int gWholeShape1, int gWholeShape2, int gWholeShape3, int gWholeShape4,
    int validM, int validN, int validK, int reluMode = 0>
__global__ AICORE void TStoreAcc2gmVectorNz2NDC1HWC0(
    __gm__ dstDataType* out, __gm__ srcDataType* src0, __gm__ srcDataType* src1, __gm__ uint64_t* quantTensor)
{
    ...
    using GlobalDataSrc2 = GlobalTensor<
        uint64_t, Shape<1, 1, 1, 1, alignScalingN>,
...
void LaunchTStoreAcc2gmNz2nd(uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream)
{
    if constexpr (tilingKey == 1) {
        ...
        TStoreAcc2gmNz2nd<1, float, float, bfloat16_t, 1, 1, 1, 13, 32, 1, 1, 1, 13, 32, 13, 32, 25>
            <<<1, nullptr, stream>>>(
                reinterpret_cast<float*>(out), reinterpret_cast<bfloat16_t*>(src0),
...
void LaunchTStoreAcc2gmScalarNz2NDC1HWC0(uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant)
{
    if constexpr (tilingKey == 1) {
        ...
        TStoreAcc2gmScalarNz2NDC1HWC0<0, float, uint8_t, float, 1, 1, 2, 7, 10, 1, 1, 2, 7, 10, 70, 64, 25>
            <<<1, nullptr, stream>>>(
                reinterpret_cast<uint8_t*>(out), reinterpret_cast<float*>(src0), reinterpret_cast<float*>(src1),
                scalarQuant);
    }
}
...
void LaunchTStoreAcc2gmScalarNz2nz(uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant)
{
    if constexpr (tilingKey == 1) {
        ...
        TStoreAcc2gmScalarNz2nz<0, float, uint8_t, bfloat16_t, 1, 2, 2, 16, 32, 1, 2, 2, 16, 32, 32, 64, 16>
            <<<1, nullptr, stream>>>(
                reinterpret_cast<uint8_t*>(out), reinterpret_cast<bfloat16_t*>(src0),
...
template void LaunchTStoreAcc2gmVectorNz2nd<4>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2nd<5>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2nz<1>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2nz<2>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2nz<3>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2nz<4>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2NDC1HWC0<1>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
