...
template void LaunchTXorS<uint32_t, 64, 64, 64, 64, 64, 64>(
    uint32_t* out, uint32_t* src, uint32_t scalar, void* stream);
template void LaunchTXorS<uint32_t, 32, 128, 32, 128, 32, 128>(
    uint32_t* out, uint32_t* src, uint32_t scalar, void* stream);
template void LaunchTXorS<uint32_t, 32, 112, 32, 128, 32, 111>(
    uint32_t* out, uint32_t* src, uint32_t scalar, void* stream);
