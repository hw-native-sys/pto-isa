...
{
    this->Launch<aclFloat16, uint8_t, 2, 16, 2, 32, 2, 16, 2, 16>();
}
TEST_F(TSELSTest, case_half_uint16_2x16_2x16_2x16_2x16)
{
    this->Launch<aclFloat16, uint16_t, 2, 16, 2, 16, 2, 16, 2, 16>();
}
TEST_F(TSELSTest, case_half_uint32_2x16_2x8_2x16_2x16)
{
    this->Launch<aclFloat16, uint32_t, 2, 16, 2, 8, 2, 16, 2, 16>();
}
