...
{
    bool ret = TLRELUTestFramework<1, float, 32, 64, 32, 32, 64, 64>();
    EXPECT_TRUE(ret);
}

TEST_F(TLRELUTest, case2)
{
    bool ret = TLRELUTestFramework<2, aclFloat16, 63, 64, 63, 63, 64, 64>();
    EXPECT_TRUE(ret);
}

TEST_F(TLRELUTest, case3)
{
    bool ret = TLRELUTestFramework<3, float, 31, 128, 31, 31, 128, 128>();
    EXPECT_TRUE(ret);
}

TEST_F(TLRELUTest, case4)
{
    bool ret = TLRELUTestFramework<4, aclFloat16, 15, 192, 15, 15, 192, 192>();
    EXPECT_TRUE(ret);
}

TEST_F(TLRELUTest, case5)
{
    bool ret = TLRELUTestFramework<5, float, 7, 448, 7, 7, 448, 448>();
    EXPECT_TRUE(ret);
}

TEST_F(TLRELUTest, case6)
{
    bool ret = TLRELUTestFramework<6, float, 256, 16, 256, 256, 16, 16>();
    EXPECT_TRUE(ret);
}

TEST_F(TLRELUTest, case7)
{
    bool ret = TLRELUTestFramework<7, float, 32, 128, 32, 32, 64, 64>();
    EXPECT_TRUE(ret);
}

TEST_F(TLRELUTest, case8)
{
    bool ret = TLRELUTestFramework<8, aclFloat16, 63, 128, 63, 63, 64, 64>();
    EXPECT_TRUE(ret);
}

TEST_F(TLRELUTest, case9)
{
    bool ret = TLRELUTestFramework<9, float, 31, 256, 31, 31, 128, 128>();
    EXPECT_TRUE(ret);
}

TEST_F(TLRELUTest, case10)
{
    bool ret = TLRELUTestFramework<10, aclFloat16, 15, 192, 15, 15, 192, 192>();
    EXPECT_TRUE(ret);
}

TEST_F(TLRELUTest, case11)
{
    bool ret = TLRELUTestFramework<11, float, 7, 512, 7, 7, 448, 448>();
    EXPECT_TRUE(ret);
}

TEST_F(TLRELUTest, case12)
{
    bool ret = TLRELUTestFramework<12, float, 256, 32, 256, 256, 16, 16>();
    EXPECT_TRUE(ret);
}
