...
TEST_F(TMOVTest, case_nz2nd_1) { tmov_acc2vec_test<1, half, half, half, 1, 0, 16, false, 64, 128>(60, 127, 120); }

TEST_F(TMOVTest, case_nz2nd_2) { tmov_acc2vec_test<1, half, half, half, 2, 5, 0, false, 120, 96>(110, 100, 80); }

TEST_F(TMOVTest, case_nz2nd_4) { tmov_acc2vec_test<1, half, half, half, 4, 3, 32, false, 150, 160>(111, 47, 96); }

TEST_F(TMOVTest, case_nz2nd_fb_quant_1)
{
    tmov_acc2vec_fb_quant_test<1, int32_t, int8_t, int8_t, uint64_t, 1, 0, 32, false, 40, 96>(30, 48, 64);
}

TEST_F(TMOVTest, case_nz2nd_fb_quant_2)
{
    tmov_acc2vec_fb_quant_test<1, int32_t, int8_t, int8_t, uint64_t, 2, 5, 0, false, 70, 96>(60, 128, 32);
}

TEST_F(TMOVTest, case_nz2nd_fb_quant_3)
{
    tmov_acc2vec_fb_quant_test<1, int32_t, int8_t, int8_t, uint64_t, 3, 0, 0, false, 128, 96>(128, 64, 96);
}

TEST_F(TMOVTest, case_nz2nd_sc_quant_4)
{
    tmov_acc2vec_test<4, int32_t, int8_t, int8_t, 4, 3, 0, false, 64, 64>(60, 128, 32);
}
