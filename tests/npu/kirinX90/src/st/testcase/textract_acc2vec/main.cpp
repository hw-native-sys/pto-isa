...
{
    tmov_acc2vec_test<1, half, half, half, 1, 0, 16, false, 64, 128>(60, 127, 120);
}

TEST_F(TMOVTest, case_nz2nd_2)
{
    tmov_acc2vec_test<1, half, half, half, 2, 5, 0, false, 120, 96>(110, 100, 80);
}

TEST_F(TMOVTest, case_nz2nd_4)
{
    tmov_acc2vec_test<1, half, half, half, 4, 3, 32, false, 150, 160>(111, 47, 96);
}
