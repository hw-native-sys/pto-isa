...
TEST_F(TStoreTest, fp4case1) { TestTstoreB4<2, uint8_t, 1, 2, 1, 16, 32, 2, 4, 2, 16, 32>(); }
TEST_F(TStoreTest, fp4case2) { TestTstoreB4<0, uint8_t, 2, 2, 3, 23, 47, 3, 3, 4, 32, 50>(); }
TEST_F(TStoreTest, fp4case3) { TestTstoreB4<1, uint8_t, 2, 3, 7, 47, 13, 2, 3, 7, 55, 29>(); }