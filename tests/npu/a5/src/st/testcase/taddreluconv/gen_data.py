...
if __name__ == "__main__":
    case_params_list = [
        ...
        TADDRELUCONVParams("TADDRELUCONVTest.case1", "f322f16", 32, 64),
        TADDRELUCONVParams("TADDRELUCONVTest.case2", "f322f16", 16, 128),
        TADDRELUCONVParams("TADDRELUCONVTest.case3", "f322f16", 31, 96),
        TADDRELUCONVParams("TADDRELUCONVTest.case4", "f322f16", 7, 192),
        TADDRELUCONVParams("TADDRELUCONVTest.case5", "f322f16", 64, 64),
        TADDRELUCONVParams("TADDRELUCONVTest.case6", "f322f16", 13, 48),
        # --- float->half: all-negative (ReLU zeros everything) ---
        TADDRELUCONVParams("TADDRELUCONVTest.case7", "f322f16", 16, 64, src0_range=(-4, -0.1), src1_range=(-4, -0.1)),
        # --- float->half: near-zero boundary (many sums ≈ 0) ---
        TADDRELUCONVParams("TADDRELUCONVTest.case8", "f322f16", 8, 128, src0_range=(-2, 2), src1_range=(-2, 2)),
        # --- float->half: wide tile, multi-repeat (col=256) ---
        TADDRELUCONVParams("TADDRELUCONVTest.case9", "f322f16", 4, 256),
        # --- float->half: narrow tile, pure tail (col=32 < elementsPerRepeat=64) ---
        TADDRELUCONVParams("TADDRELUCONVTest.case10", "f322f16", 16, 32),
        # --- half->int8: basic random ---
        TADDRELUCONVParams("TADDRELUCONVTest.case11", "f162s8", 16, 128, src0_range=(-10, 10), src1_range=(-10, 10)),
        # --- half->int8: tail-only (col=64 < elementsPerRepeat=128) ---
        TADDRELUCONVParams("TADDRELUCONVTest.case12", "f162s8", 8, 64, src0_range=(-10, 10), src1_range=(-10, 10)),
        # --- half->int8: all-negative (ReLU zeros, quant path) ---
        TADDRELUCONVParams("TADDRELUCONVTest.case13", "f162s8", 8, 128, src0_range=(-5, -0.1), src1_range=(-5, -0.1)),
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case19_fp32_partial_32x128_16x96", "f322f16", 32, 128, valid_row=16, valid_col=96
        ),
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case20_fp32_partial_col_16x128_16x65", "f322f16", 16, 128, valid_row=16, valid_col=65
        ),
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case21_fp32_partial_row_32x64_10x64", "f322f16", 32, 64, valid_row=10, valid_col=64
        ),
        # --- f322f16: extreme shapes ---
        TADDRELUCONVParams("TADDRELUCONVTest.case22_fp32_single_row_1x256", "f322f16", 1, 256),
        TADDRELUCONVParams("TADDRELUCONVTest.case23_fp32_many_rows_128x32", "f322f16", 128, 32),
        # --- f322f16: value patterns ---
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case24_fp32_zero_src0_16x128",
            "f322f16",
            16,
            128,
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case25_fp32_negate_src1_16x64",
            "f322f16",
            16,
            64,
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case26_fp32_large_values_16x128",
            "f322f16",
            16,
            128,
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case27_fp16_partial_16x256_8x192",
            "f162s8",
            16,
            256,
            valid_row=8,
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case28_fp16_partial_col_8x256_8x129",
            "f162s8",
            8,
            256,
            valid_row=8,
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case29_fp16_single_row_1x128",
            "f162s8",
            1,
            128,
            src0_range=(-10, 10),
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case30_fp16_zero_src0_8x128",
            "f162s8",
            8,
            128,
            special_mode="zero_src0",
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case31_fp16_negate_src1_8x128",
            "f162s8",
            8,
            128,
            special_mode="negate_src1",
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case32_fp16_near_saturation_16x128",
            "f162s8",
            16,
            128,
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case33_s16_partial_16x256_10x192",
            "s162s8",
            16,
            256,
            valid_row=10,
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case34_s16_partial_col_8x256_8x129",
            "s162s8",
            8,
            256,
            valid_row=8,
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case35_s16_single_row_1x128",
            "s162s8",
            1,
            128,
            src0_fn=_make_int_gen(-50, 50),
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case36_s16_zero_src0_8x128",
            "s162s8",
            8,
            128,
            special_mode="zero_src0",
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case37_s16_negate_src1_8x128",
            "s162s8",
            8,
            128,
            special_mode="negate_src1",
        ...
        TADDRELUCONVParams(
            "TADDRELUCONVTest.case38_s16_near_saturation_8x128",
            "s162s8",
            8,
            128,
            special_mode="near_saturation",
