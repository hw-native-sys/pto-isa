...
extern "C" __global__ AICORE void launchTADDRELUCONVCase19(__gm__ aclFloat16 *out, __gm__ float *src0,
                                                           __gm__ float *src1)
{
    runTADDRELUCONV<half, float, 32, 16, 128, 96>((__gm__ half *)out, src0, src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase20(__gm__ aclFloat16 *out, __gm__ float *src0,
                                                           __gm__ float *src1)
{
    runTADDRELUCONV<half, float, 16, 16, 128, 65>((__gm__ half *)out, src0, src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase21(__gm__ aclFloat16 *out, __gm__ float *src0,
                                                           __gm__ float *src1)
{
    runTADDRELUCONV<half, float, 32, 10, 64, 64>((__gm__ half *)out, src0, src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase22(__gm__ aclFloat16 *out, __gm__ float *src0,
                                                           __gm__ float *src1)
{
    runTADDRELUCONV<half, float, 1, 1, 256, 256>((__gm__ half *)out, src0, src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase23(__gm__ aclFloat16 *out, __gm__ float *src0,
                                                           __gm__ float *src1)
{
    runTADDRELUCONV<half, float, 128, 128, 32, 32>((__gm__ half *)out, src0, src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase24(__gm__ aclFloat16 *out, __gm__ float *src0,
                                                           __gm__ float *src1)
{
    runTADDRELUCONV<half, float, 16, 16, 128, 128>((__gm__ half *)out, src0, src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase25(__gm__ aclFloat16 *out, __gm__ float *src0,
                                                           __gm__ float *src1)
{
    runTADDRELUCONV<half, float, 16, 16, 64, 64>((__gm__ half *)out, src0, src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase26(__gm__ aclFloat16 *out, __gm__ float *src0,
                                                           __gm__ float *src1)
{
    runTADDRELUCONV<half, float, 16, 16, 128, 128>((__gm__ half *)out, src0, src1);
}

extern "C" __global__ AICORE void launchTADDRELUCONVCase27(__gm__ int8_t *out, __gm__ aclFloat16 *src0,
                                                           __gm__ aclFloat16 *src1)
{
    runTADDRELUCONV<int8_t, half, 16, 8, 256, 192>(out, (__gm__ half *)src0, (__gm__ half *)src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase28(__gm__ int8_t *out, __gm__ aclFloat16 *src0,
                                                           __gm__ aclFloat16 *src1)
{
    runTADDRELUCONV<int8_t, half, 8, 8, 256, 129>(out, (__gm__ half *)src0, (__gm__ half *)src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase29(__gm__ int8_t *out, __gm__ aclFloat16 *src0,
                                                           __gm__ aclFloat16 *src1)
{
    runTADDRELUCONV<int8_t, half, 1, 1, 128, 128>(out, (__gm__ half *)src0, (__gm__ half *)src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase30(__gm__ int8_t *out, __gm__ aclFloat16 *src0,
                                                           __gm__ aclFloat16 *src1)
{
    runTADDRELUCONV<int8_t, half, 8, 8, 128, 128>(out, (__gm__ half *)src0, (__gm__ half *)src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase31(__gm__ int8_t *out, __gm__ aclFloat16 *src0,
                                                           __gm__ aclFloat16 *src1)
{
    runTADDRELUCONV<int8_t, half, 8, 8, 128, 128>(out, (__gm__ half *)src0, (__gm__ half *)src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase32(__gm__ int8_t *out, __gm__ aclFloat16 *src0,
                                                           __gm__ aclFloat16 *src1)
{
    runTADDRELUCONV<int8_t, half, 16, 16, 128, 128>(out, (__gm__ half *)src0, (__gm__ half *)src1);
}

extern "C" __global__ AICORE void launchTADDRELUCONVCase33(__gm__ int8_t *out, __gm__ int16_t *src0,
                                                           __gm__ int16_t *src1)
{
    runTADDRELUCONV<int8_t, int16_t, 16, 10, 256, 192>(out, src0, src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase34(__gm__ int8_t *out, __gm__ int16_t *src0,
                                                           __gm__ int16_t *src1)
{
    runTADDRELUCONV<int8_t, int16_t, 8, 8, 256, 129>(out, src0, src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase35(__gm__ int8_t *out, __gm__ int16_t *src0,
                                                           __gm__ int16_t *src1)
{
    runTADDRELUCONV<int8_t, int16_t, 1, 1, 128, 128>(out, src0, src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase36(__gm__ int8_t *out, __gm__ int16_t *src0,
                                                           __gm__ int16_t *src1)
{
    runTADDRELUCONV<int8_t, int16_t, 8, 8, 128, 128>(out, src0, src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase37(__gm__ int8_t *out, __gm__ int16_t *src0,
                                                           __gm__ int16_t *src1)
{
    runTADDRELUCONV<int8_t, int16_t, 8, 8, 128, 128>(out, src0, src1);
}
extern "C" __global__ AICORE void launchTADDRELUCONVCase38(__gm__ int8_t *out, __gm__ int16_t *src0,
                                                           __gm__ int16_t *src1)
{
    runTADDRELUCONV<int8_t, int16_t, 8, 8, 128, 128>(out, src0, src1);
}
