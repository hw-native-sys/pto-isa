...
template void TPartMinTest::LaunchTPartMin<float, 8, 8, 0, 0, 0, 0, 1, 8, 1, 8, 1, 8>(float *out, float *src0,
...
template void TPartMinTest::LaunchTPartMin<float, 8, 8, 8, 8, 0, 8, 8, 8, 8, 8, 1, 8>(float *out, float *src0,
                                                                                      float *src1, void *stream);
template void TPartMinTest::LaunchTPartMin<float, 8, 8, 5, 4, 3, 0, 8, 8, 8, 8, 1, 8>(float *out, float *src0,
                                                                                      float *src1, void *stream);
template void TPartMinTest::LaunchTPartMin<float, 8, 8, 3, 0, 5, 4, 8, 8, 1, 8, 8, 8>(float *out, float *src0,
                                                                                      float *src1, void *stream);
