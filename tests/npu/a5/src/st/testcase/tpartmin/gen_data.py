...
if __name__ == "__main__":
    ...
    case_params_list = [
        ...
        TPartMinParams(np.float32, 2, 24, 2, 24, 1, 8),
        TPartMinParams(np.float32, 128, 64, 128, 64, 96, 64),
        TPartMinParams(np.float32, 95, 95, 95, 95, 95, 95),
        TPartMinParams(np.float32, 122, 123, 104, 123, 122, 123),
        TPartMinParams(np.float16, 122, 123, 104, 123, 122, 123),
        TPartMinParams(np.int8, 122, 123, 104, 123, 122, 123),
        TPartMinParams(np.int16, 122, 123, 104, 123, 122, 123),
        TPartMinParams(np.int32, 122, 123, 104, 123, 122, 123),
        TPartMinParams(np.uint8, 122, 123, 104, 123, 122, 123),
        TPartMinParams(np.uint16, 122, 123, 104, 123, 122, 123),
        TPartMinParams(np.uint32, 122, 123, 104, 123, 122, 123),
        ...
        TPartMinParams(np.int64, 4, 16, 2, 16, 4, 16),
        TPartMinParams(np.uint64, 4, 16, 2, 16, 4, 16),
    ]
