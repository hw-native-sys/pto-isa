...
TEST_F(CONCAT(CASENAME, Test), case_int32_64x64_64x64) { CONCAT(test_, CASENAME)<int32_t, 64, 64, 64, 64>(); }
TEST_F(CONCAT(CASENAME, Test), case_int16_64x64_64x64) { CONCAT(test_, CASENAME)<int16_t, 64, 64, 64, 64>(); }
