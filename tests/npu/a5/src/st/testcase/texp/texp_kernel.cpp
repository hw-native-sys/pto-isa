...
template <
    typename T, int dstRow, int dstCol, int srcRow, int srcCol, int validRow, int validCol, bool isInPlace,
    bool highPrecision>
...
template void LaunchTExp<aclFloat16, 64, 64, 64, 64, 64, 64, false, true>(
