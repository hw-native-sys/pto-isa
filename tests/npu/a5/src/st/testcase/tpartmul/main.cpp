...
TEST_F(TPARTMULTest, case_float_64x64_64x64_64x64) { test_tpartmul<float, 64, 64, 64, 64, 64, 64>(); }
TEST_F(TPARTMULTest, case_float_64x64_8x64_64x64) { test_tpartmul<float, 64, 64, 8, 64, 64, 64>(); }
TEST_F(TPARTMULTest, case_float_64x64_64x8_64x64) { test_tpartmul<float, 64, 64, 64, 8, 64, 64>(); }
TEST_F(TPARTMULTest, case_float_64x64_64x64_8x64) { test_tpartmul<float, 64, 64, 64, 64, 8, 64>(); }
TEST_F(TPARTMULTest, case_float_64x64_64x64_64x8) { test_tpartmul<float, 64, 64, 64, 64, 64, 8>(); }
TEST_F(TPARTMULTest, case_half_8x48_8x16_8x48) { test_tpartmul<aclFloat16, 8, 48, 8, 16, 8, 48>(); }
TEST_F(TPARTMULTest, case_half_8x768_8x512_8x768) { test_tpartmul<aclFloat16, 8, 768, 8, 512, 8, 768>(); }
TEST_F(TPARTMULTest, case_int16_8x48_8x48_8x16) { test_tpartmul<int16_t, 8, 48, 8, 48, 8, 16>(); }
TEST_F(TPARTMULTest, case_int32_64x64_8x64_64x64) { test_tpartmul<int32_t, 64, 64, 8, 64, 64, 64>(); }