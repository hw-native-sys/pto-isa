...
TEST_F(TPushPopVCNSTest, case1_int8_single_k_tile) { TPushPopVCNSMatmulTestFunc<int8_t, float, float, 1>(16, 64, 32); }

TEST_F(TPushPopVCNSTest, case2_int8_two_k_tiles) { TPushPopVCNSMatmulTestFunc<int8_t, float, float, 2>(16, 128, 32); }

TEST_F(TPushPopVCNSTest, case3_int8_four_k_tiles) { TPushPopVCNSMatmulTestFunc<int8_t, float, float, 3>(16, 256, 32); }
...
TEST_F(TPushPopVCNSTest, case5_int16_two_k_tiles) { TPushPopVCNSMatmulTestFunc<int16_t, float, float, 5>(16, 128, 32); }
