...
void LaunchTPartArgMin(T *outVal, T *src0Val, T *src1Val, U *outIdx, U *src0Idx, U *src1Idx, void *stream);
...
void test_tpartargmin()
{
    ...
    LaunchTPartArgMin<T, U, dstVR, dstVC, src0VR, src0VC, src1VR, src1VC, dstTR, dstTC, src0TR, src0TC, src1TR, src1TC,
...
TEST_F(TPARTARGMINTest, case_fp32_64x64_64x64_64x64)
{
    test_tpartargmin<float, uint32_t, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64>();
}
TEST_F(TPARTARGMINTest, case_fp32_2x24_2x24_2x8)
{
    test_tpartargmin<float, int32_t, 2, 24, 2, 24, 2, 8, 4, 32, 3, 24, 2, 16>();
}
TEST_F(TPARTARGMINTest, case_fp32_12x63_12x63_6x60)
{
    test_tpartargmin<float, int32_t, 12, 63, 12, 63, 6, 60, 12, 64, 12, 64, 6, 64>();
}
TEST_F(TPARTARGMINTest, case_fp16_10x31_8x16_10x31)
{
    test_tpartargmin<aclFloat16, int16_t, 10, 31, 8, 16, 10, 31, 10, 32, 8, 32, 12, 32, true>();
}
TEST_F(TPARTARGMINTest, case_fp16_5x33_5x33_5x30)
{
    test_tpartargmin<aclFloat16, uint16_t, 5, 33, 5, 33, 5, 30, 8, 48, 5, 48, 6, 48, true>();
}
TEST_F(TPARTARGMINTest, case_fp32_8x7_8x7_8x0)
{
    test_tpartargmin<float, uint32_t, 8, 7, 8, 7, 8, 0, 8, 8, 8, 8, 1, 8>();
}
TEST_F(TPARTARGMINTest, case_fp32_8x7_8x7_0x7)
{
    test_tpartargmin<float, uint32_t, 8, 7, 8, 7, 0, 7, 8, 8, 8, 8, 1, 8>();
}
TEST_F(TPARTARGMINTest, case_fp32_8x7_8x0_8x7)
{
    test_tpartargmin<float, uint32_t, 8, 7, 8, 0, 8, 7, 8, 8, 1, 8, 8, 8>();
}
TEST_F(TPARTARGMINTest, case_fp32_8x7_0x7_8x7)
{
