...
TEST_F(TMOVTest, case_nz2nd_1) { tmov_acc2vec_test<1, uint32_t, uint16_t, uint16_t, 1>(60, 127, 120); }

TEST_F(TMOVTest, case_nz2nd_2) { tmov_acc2vec_test<1, uint16_t, uint16_t, uint16_t, 2>(110, 100, 80); }

TEST_F(TMOVTest, case_nz2nd_3) { tmov_acc2vec_test<1, uint32_t, uint16_t, uint16_t, 3>(6, 7, 8); }

TEST_F(TMOVTest, case_nz2nd_4) { tmov_acc2vec_test<1, uint16_t, uint16_t, uint16_t, 4>(111, 47, 96); }

TEST_F(TMOVTest, case_nz2nd_split_1) { tmov_acc2vec_test<1, uint32_t, uint16_t, uint16_t, 5>(96, 32, 48); }
...
TEST_F(TMOVTest, case_nz2nz_2) { tmov_acc2vec_test<2, uint32_t, uint16_t, uint16_t, 2>(80, 112, 96); }

TEST_F(TMOVTest, case_nz2nz_3) { tmov_acc2vec_test<2, uint32_t, uint32_t, uint32_t, 3>(16, 16, 16); }

TEST_F(TMOVTest, case_nz2nz_4) { tmov_acc2vec_test<2, uint16_t, uint16_t, uint16_t, 4>(48, 112, 48); }

TEST_F(TMOVTest, case_nz2nz_split_1) { tmov_acc2vec_test<2, uint32_t, uint32_t, uint32_t, 5>(48, 80, 128); }

TEST_F(TMOVTest, case_nz2nz_split_2) { tmov_acc2vec_test<2, uint32_t, uint16_t, uint16_t, 6>(80, 16, 96); }

TEST_F(TMOVTest, case_nz2nz_split_3) { tmov_acc2vec_test<2, uint32_t, uint16_t, uint16_t, 7>(112, 48, 80); }

TEST_F(TMOVTest, case_nz2nz_split_4) { tmov_acc2vec_test<2, uint32_t, uint32_t, uint32_t, 8>(16, 112, 112); }
...
TEST_F(TMOVTest, case_nz2nz_sc_quant_1) { tmov_acc2vec_test<5, uint16_t, uint32_t, uint32_t, 1>(48, 32, 80); }

TEST_F(TMOVTest, case_nz2nz_sc_quant_2) { tmov_acc2vec_test<5, uint16_t, int8_t, int8_t, 2>(96, 48, 128); }

TEST_F(TMOVTest, case_nz2nz_sc_quant_3) { tmov_acc2vec_test<5, int8_t, int8_t, int8_t, 3>(128, 64, 128); }

TEST_F(TMOVTest, case_nz2nz_sc_quant_4) { tmov_acc2vec_test<5, int8_t, uint32_t, uint32_t, 4>(64, 80, 96); }
...
TEST_F(TMOVTest, case_nz2nd_sc_quant_1) { tmov_acc2vec_test<4, uint16_t, uint32_t, uint32_t, 1>(128, 48, 96); }

TEST_F(TMOVTest, case_nz2nd_sc_quant_2) { tmov_acc2vec_test<4, int8_t, uint32_t, uint32_t, 2>(60, 128, 64); }
...
TEST_F(TMOVTest, case_nz2dn_1) { tmov_acc2vec_test<3, uint32_t, uint32_t, uint32_t, 1>(8, 7, 6); }
...
TEST_F(TMOVTest, case_nz2dn_4) { tmov_acc2vec_test<3, uint32_t, uint16_t, uint16_t, 4>(88, 48, 95); }
...
TEST_F(TMOVTest, case_nz2dn_sc_quant_1) { tmov_acc2vec_test<6, uint16_t, float, float, 1>(80, 40, 66); }

TEST_F(TMOVTest, case_nz2dn_sc_quant_2) { tmov_acc2vec_test<6, int8_t, float, float, 2>(96, 128, 60); }
