...
void test_trowexpand()
{
    ...
    launchTROWEXPAND<T, dstRows, dstCols>(dstDevice, src0Device, stream);
...
TEST_F(TROWEXPANDBRCBTest, case0_half_4800_16) { test_trowexpand<aclFloat16, 4800, 16>(); }
TEST_F(TROWEXPANDBRCBTest, case1_float_7280_8) { test_trowexpand<float, 7280, 8>(); }
