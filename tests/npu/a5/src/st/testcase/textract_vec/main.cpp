...
TEST_F(TExtractVecTest, case_nd_aligned_4) { testND<4, uint16_t>(32, 32, 16, 16); }
...
TEST_F(TExtractVecTest, case_nd_aligned_hif8) { testND<13, uint8_t>(32, 64, 16, 32); }
...
TEST_F(TExtractVecTest, case_nz_4) { testNZ<4, uint16_t>(32, 32, 16, 32); }
...
TEST_F(TExtractVecTest, case_nz_hif8) { testNZ<10, uint8_t>(32, 64, 16, 64); }
TEST_F(TExtractVecTest, case_nz_fp8_e4m3) { testNZ<11, uint8_t>(32, 64, 16, 64); }
TEST_F(TExtractVecTest, case_nz_fp8_e5m2) { testNZ<12, uint8_t>(32, 64, 16, 64); }
...
TEST_F(TExtractVecTest, case_nz_scalar_3) { testNZScalar<3, uint16_t>(32, 32, 16, 32); }
...
TEST_F(TExtractVecTest, case_nz_scalar_fp4_e2m1) { testNZScalar<6, uint8_t>(16, 64, 16, 64); }
TEST_F(TExtractVecTest, case_nz_scalar_fp4_e1m2) { testNZScalar<7, uint8_t>(16, 64, 16, 64); }
