...
__tf__ PTO_INTERNAL void tf_mad_mx(
    typename TileDataDst::TileDType __out__ dst, typename TileDataSrc0::TileDType __in__ src0,
    typename TileDataSrc1::TileDType __in__ src1, int M, int K, int N, bool a, bool b, bool c, bool d)
{
...
__tf__ PTO_INTERNAL void DynGM2L1(
    typename TileDataDst::TileDType __out__ dst, __gm__ T* src, unsigned TShape0, unsigned TShape1)
{
    if (std::is_same<T, float4_e2m1x2_t>::value || std::is_same<T, float4_e1m2x2_t>::value) {
        ...
        copy_gm_to_cbuf_align_v2(
            (__cbuf__ uint8_t*)__cce_get_tile_ptr(dst), (__gm__ uint8_t*)src, 0, 1, lenBurst, 0, 0, 0, 0, 0, 0);
    } else {
...
__tf__ PTO_INTERNAL void MOV_MX_TOA(
    typename TileDataDst::TileDType __out__ dst, typename TileDataSrc::TileDType __in__ src, unsigned dstM,
    unsigned dstK)
{
    ...
    load_cbuf_to_ca_mx(
        mxDstAddr, static_cast<__cbuf__ void*>(__cce_get_tile_ptr(src)), 0, 0, mStep, kStep, srcStride, dstStride);
}

template <typename TileDataDst, typename TileDataSrc>
__tf__ PTO_INTERNAL void MOV_MX_TOB(
    typename TileDataDst::TileDType __out__ dst, typename TileDataSrc::TileDType __in__ src, unsigned dstK,
    unsigned dstN)
{
    uint64_t mxDstAddr = static_cast<uint64_t>(reinterpret_cast<uintptr_t>(__cce_get_tile_ptr(dst))) / 16;
    constexpr int c0Size = 2;
...
template <
    typename T, typename U, typename S, typename X, int M, int K, int N, uint16_t indexM, uint16_t indexK,
...
{
    runTEXTRACT<float, float, float, 128, 48, 64, 0, 0, 0, false, false>(
...
{
    runTEXTRACT<float, half, half, 64, 96, 64, 32, 16, 16, false, false>(
        reinterpret_cast<__gm__ float*>(out), reinterpret_cast<__gm__ half*>(src0),
        reinterpret_cast<__gm__ half*>(src1));
}
extern "C" __global__ AICORE void launchTEXTRACT_5(__gm__ uint8_t* out, __gm__ uint8_t* src0, __gm__ uint8_t* src1)
{
    runTEXTRACT<float, float, float, 64, 128, 64, 32, 32, 16, false, false>(
        reinterpret_cast<__gm__ float*>(out), reinterpret_cast<__gm__ float*>(src0),
        reinterpret_cast<__gm__ float*>(src1));
}
...
{
    runTEXTRACT<float, half, half, 64, 128, 64, 0, 64, 0, true, true>(
        reinterpret_cast<__gm__ float*>(out), reinterpret_cast<__gm__ half*>(src0),
        reinterpret_cast<__gm__ half*>(src1));
}
extern "C" __global__ AICORE void launchTEXTRACT_8(__gm__ uint8_t* out, __gm__ uint8_t* src0, __gm__ uint8_t* src1)
{
    runTEXTRACT<float, float, float, 64, 64, 128, 0, 0, 32, true, true>(
        reinterpret_cast<__gm__ float*>(out), reinterpret_cast<__gm__ float*>(src0),
        reinterpret_cast<__gm__ float*>(src1));
}
...
extern "C" __global__ AICORE void launchTEXTRACT_17(
    __gm__ uint8_t* out, __gm__ uint8_t* src0, __gm__ uint8_t* src1, __gm__ uint8_t* srcMx0, __gm__ uint8_t* srcMx1)
{
...
extern "C" __global__ AICORE void launchTEXTRACT_18(
    __gm__ uint8_t* out, __gm__ uint8_t* src0, __gm__ uint8_t* src1, __gm__ uint8_t* srcMx0, __gm__ uint8_t* srcMx1)
{
...
extern "C" __global__ AICORE void launchTEXTRACT_19(
    __gm__ uint8_t* out, __gm__ uint8_t* src0, __gm__ uint8_t* src1, __gm__ uint8_t* srcMx0, __gm__ uint8_t* srcMx1)
{
...
extern "C" __global__ AICORE void launchTEXTRACT_20(
    __gm__ uint8_t* out, __gm__ uint8_t* src0, __gm__ uint8_t* src1, __gm__ uint8_t* srcMx0, __gm__ uint8_t* srcMx1)
{
...
template void launchTEXTRACTMX<18>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* srcMx0, uint8_t* srcMx1, void* stream);
template void launchTEXTRACTMX<19>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* srcMx0, uint8_t* srcMx1, void* stream);
template void launchTEXTRACTMX<20>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* srcMx0, uint8_t* srcMx1, void* stream);
...
template <
    typename T, typename U, typename S, int M, int K, int N, bool isAtranspose, bool isBtranspose, int targetM,
...
AICORE inline void runTMOV_UNALIGN(__gm__ T* out, __gm__ U* src0, __gm__ S* src1)
{
    using GlobalDataSrc0 = std::conditional_t<
        isAtranspose,
        GlobalTensor<
            U, pto::Shape<1, 1, 1, targetM, targetK>,
            pto::Stride<1 * targetM * targetK, 1 * targetM * targetK, targetM * targetK, 1, targetM>, Layout::DN>,
        GlobalTensor<
            U, pto::Shape<1, 1, 1, targetM, targetK>,
            pto::Stride<1 * targetM * targetK, 1 * targetM * targetK, targetM * targetK, targetK, 1>, Layout::ND>>;
    using GlobalDataSrc1 = std::conditional_t<
        isBtranspose,
        GlobalTensor<
            S, pto::Shape<1, 1, 1, targetK, targetN>,
            pto::Stride<1 * targetK * targetN, 1 * targetK * targetN, targetK * targetN, targetN, 1>, Layout::ND>,
        GlobalTensor<
            S, pto::Shape<1, 1, 1, targetK, targetN>,
            pto::Stride<1 * targetK * targetN, 1 * targetK * targetN, targetK * targetN, 1, targetK>, Layout::DN>>;
    using GlobalDataOut = GlobalTensor<T, pto::Shape<1, 1, 1, M, N>, pto::Stride<1 * M * N, 1 * M * N, M * N, N, 1>>;
...
{
    runTMOV<float, hifloat8_t, hifloat8_t, 128, 128, 64, true, false>(
        reinterpret_cast<__gm__ float*>(out), reinterpret_cast<__gm__ hifloat8_t*>(src0),
        reinterpret_cast<__gm__ hifloat8_t*>(src1));
}
...
{
    runTMOV_DYNAMIC<float, half, half, 64, 128, 64, true, false>(
        reinterpret_cast<__gm__ float*>(out), reinterpret_cast<__gm__ half*>(src0),
...
{
    runTMOV_DYNAMIC<float, float, float, 64, 128, 64, false, true>(
        reinterpret_cast<__gm__ float*>(out), reinterpret_cast<__gm__ float*>(src0),
...
{
    runTMOV_UNALIGN<float, half, half, 65, 40, 66, true, true, 80, 48, 80>(
        reinterpret_cast<__gm__ float*>(out), reinterpret_cast<__gm__ half*>(src0),
        reinterpret_cast<__gm__ half*>(src1));
}
extern "C" __global__ AICORE void launchTMOV_13(__gm__ uint8_t* out, __gm__ uint8_t* src0, __gm__ uint8_t* src1)
{
    runTMOV_UNALIGN<float, float, float, 65, 40, 66, true, true, 80, 48, 80>(
        reinterpret_cast<__gm__ float*>(out), reinterpret_cast<__gm__ float*>(src0),
        reinterpret_cast<__gm__ float*>(src1));
}
extern "C" __global__ AICORE void launchTMOV_14(
    __gm__ uint8_t* out, __gm__ uint8_t* src0, __gm__ uint8_t* src1, __gm__ uint8_t* srcMx0, __gm__ uint8_t* srcMx1)
{
...
extern "C" __global__ AICORE void launchTMOV_15(
    __gm__ uint8_t* out, __gm__ uint8_t* src0, __gm__ uint8_t* src1, __gm__ uint8_t* srcMx0, __gm__ uint8_t* srcMx1)
{
...
extern "C" __global__ AICORE void launchTMOV_16(
    __gm__ uint8_t* out, __gm__ uint8_t* src0, __gm__ uint8_t* src1, __gm__ uint8_t* srcMx0, __gm__ uint8_t* srcMx1)
{
...
extern "C" __global__ AICORE void launchTMOV_17(
    __gm__ uint8_t* out, __gm__ uint8_t* src0, __gm__ uint8_t* src1, __gm__ uint8_t* srcMx0, __gm__ uint8_t* srcMx1)
{
...
template void launchTMOVMX<14>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* srcMx0, uint8_t* srcMx1, void* stream);
template void launchTMOVMX<15>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* srcMx0, uint8_t* srcMx1, void* stream);
template void launchTMOVMX<16>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* srcMx0, uint8_t* srcMx1, void* stream);
template void launchTMOVMX<17>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* srcMx0, uint8_t* srcMx1, void* stream);
