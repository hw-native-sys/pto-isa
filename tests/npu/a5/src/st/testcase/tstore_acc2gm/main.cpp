...
TEST_F(TStoreAcc2gmTest, case19) { test_tstore_acc2gm_scalar_nz2nd<4, uint16_t, int8_t, 17, 32, 31>(3); }

TEST_F(TStoreAcc2gmTest, case20) { test_tstore_acc2gm_scalar_nz2nz<1, uint16_t, int8_t, 64, 32, 64>(5); }

TEST_F(TStoreAcc2gmTest, case21) { test_tstore_acc2gm_scalar_nz2nz<2, int8_t, int8_t, 32, 32, 32>(2); }

TEST_F(TStoreAcc2gmTest, case22) { test_tstore_acc2gm_scalar_nz2nz<3, uint8_t, int8_t, 160, 64, 17>(2); }

TEST_F(TStoreAcc2gmTest, case23) { test_tstore_acc2gm_scalar_nz2nz<4, uint16_t, int8_t, 16, 96, 29>(2); }
...
TEST_F(TStoreAcc2gmTest, case27) { test_tstore_acc2gm_scalar_nz2nd<8, uint16_t, uint16_t, 160, 79, 51>(3); }

TEST_F(TStoreAcc2gmTest, case28) { test_tstore_acc2gm_scalar_nz2nd<9, uint8_t, uint16_t, 17, 57, 33>(2); }

TEST_F(TStoreAcc2gmTest, case29) { test_tstore_acc2gm_scalar_nz2nz<5, int8_t, float, 16, 64, 15>(2); }

TEST_F(TStoreAcc2gmTest, case30) { test_tstore_acc2gm_scalar_nz2nz<6, uint8_t, uint16_t, 32, 64, 16>(2); }

TEST_F(TStoreAcc2gmTest, case31) { test_tstore_acc2gm_scalar_nz2nz<7, uint16_t, uint16_t, 128, 128, 37>(3); }

TEST_F(TStoreAcc2gmTest, case32) { test_tstore_acc2gm_scalar_nz2nz<8, uint16_t, uint16_t, 64, 32, 31>(3); }

TEST_F(TStoreAcc2gmTest, case33) { test_tstore_acc2gm_scalar_nz2nz<9, uint8_t, uint16_t, 80, 64, 10>(2); }

TEST_F(TStoreAcc2gmTest, case34) { test_tstore_acc2gm_vector_nz2nd<1, uint16_t, int8_t, 55, 88, 32>(); }

TEST_F(TStoreAcc2gmTest, case35) { test_tstore_acc2gm_vector_nz2nd<2, int8_t, int8_t, 34, 85, 19>(); }

TEST_F(TStoreAcc2gmTest, case36) { test_tstore_acc2gm_vector_nz2nd<3, uint8_t, int8_t, 31, 32, 29>(); }
...
TEST_F(TStoreAcc2gmTest, case41) { test_tstore_acc2gm_vector_nz2nd<8, uint8_t, uint16_t, 19, 32, 23>(); }

TEST_F(TStoreAcc2gmTest, case42) { test_tstore_acc2gm_vector_nz2nd<9, uint8_t, uint16_t, 99, 100, 15>(); }

TEST_F(TStoreAcc2gmTest, case43) { test_tstore_acc2gm_vector_nz2nz<1, uint16_t, int8_t, 256, 128, 63>(); }

TEST_F(TStoreAcc2gmTest, case44) { test_tstore_acc2gm_vector_nz2nz<2, uint8_t, int8_t, 32, 32, 31>(); }

TEST_F(TStoreAcc2gmTest, case45) { test_tstore_acc2gm_vector_nz2nz<3, uint8_t, int8_t, 48, 32, 23>(); }

TEST_F(TStoreAcc2gmTest, case46) { test_tstore_acc2gm_vector_nz2nz<4, uint16_t, int8_t, 80, 96, 49>(); }

TEST_F(TStoreAcc2gmTest, case47) { test_tstore_acc2gm_vector_nz2nz<5, uint16_t, uint16_t, 128, 96, 31>(); }

TEST_F(TStoreAcc2gmTest, case48) { test_tstore_acc2gm_vector_nz2nz<6, uint16_t, uint16_t, 32, 96, 17>(); }

TEST_F(TStoreAcc2gmTest, case49) { test_tstore_acc2gm_vector_nz2nz<7, int8_t, uint16_t, 32, 64, 25>(); }

TEST_F(TStoreAcc2gmTest, case50) { test_tstore_acc2gm_vector_nz2nz<8, uint8_t, uint16_t, 16, 32, 23>(); }

TEST_F(TStoreAcc2gmTest, case51) { test_tstore_acc2gm_vector_nz2nz<9, uint8_t, uint16_t, 144, 96, 37>(); }

TEST_F(TStoreAcc2gmTest, case52) { test_tstore_acc2gm_scalar_nz2nd<10, uint8_t, uint8_t, 32, 32, 31>(1); }

TEST_F(TStoreAcc2gmTest, case_relu_1) { test_tstore_acc2gm_nz2nd<21, float, float, 117, 97, 71>(); }

TEST_F(TStoreAcc2gmTest, case_relu_11) { test_tstore_acc2gm_nz2nz<21, float, uint16_t, 160, 80, 51>(); }

TEST_F(TStoreAcc2gmTest, case_relu_21) { test_tstore_acc2gm_scalar_nz2nd<21, uint8_t, uint16_t, 77, 34, 81>(2); }

TEST_F(TStoreAcc2gmTest, case_relu_31) { test_tstore_acc2gm_scalar_nz2nz<21, uint8_t, uint8_t, 96, 32, 159>(2); }

TEST_F(TStoreAcc2gmTest, case_relu_41) { test_tstore_acc2gm_vector_nz2nd<21, uint8_t, uint16_t, 85, 77, 66>(); }

TEST_F(TStoreAcc2gmTest, case_relu_51) { test_tstore_acc2gm_vector_nz2nz<21, uint8_t, uint8_t, 128, 128, 123>(); }

TEST_F(TStoreAcc2gmTest, case_nhwc_1) { test_tstore_acc2gm_nz2nd<31, float, float, 128, 128, 16>(); }

TEST_F(TStoreAcc2gmTest, case_nhwc_2) { test_tstore_acc2gm_nz2nd<32, uint32_t, uint8_t, 512, 63, 31>(); }

TEST_F(TStoreAcc2gmTest, case_nhwc_3) { test_tstore_acc2gm_nz2nd<33, uint16_t, float, 1024, 32, 8>(); }

TEST_F(TStoreAcc2gmTest, case_nhwc_4) { test_tstore_acc2gm_nz2nd<34, float, uint16_t, 126, 43, 64>(); }

TEST_F(TStoreAcc2gmTest, case_nhwc_5) { test_tstore_acc2gm_scalar_nz2nd<31, uint8_t, uint8_t, 640, 64, 96>(3); }

TEST_F(TStoreAcc2gmTest, case_nhwc_6) { test_tstore_acc2gm_vector_nz2nd<31, uint16_t, uint8_t, 352, 64, 32>(); }

TEST_F(TStoreAcc2gmTest, case_nhwc_7) { test_tstore_acc2gm_vector_nz2nd<32, float, uint16_t, 256, 128, 32>(); }

TEST_F(TStoreAcc2gmTest, case_nchw_1) { test_tstore_acc2gm_nz2nd<41, float, float, 128, 128, 16>(); }

TEST_F(TStoreAcc2gmTest, case_nchw_2) { test_tstore_acc2gm_nz2nd<42, uint32_t, uint8_t, 512, 63, 31>(); }

TEST_F(TStoreAcc2gmTest, case_nchw_3) { test_tstore_acc2gm_nz2nd<43, uint16_t, float, 1024, 32, 8>(); }

TEST_F(TStoreAcc2gmTest, case_nchw_4) { test_tstore_acc2gm_nz2nd<44, float, uint16_t, 126, 43, 64>(); }

TEST_F(TStoreAcc2gmTest, case_nchw_5) { test_tstore_acc2gm_scalar_nz2nd<41, uint8_t, uint8_t, 640, 64, 96>(3); }

TEST_F(TStoreAcc2gmTest, case_nchw_6) { test_tstore_acc2gm_vector_nz2nd<41, uint16_t, uint8_t, 352, 64, 32>(); }

TEST_F(TStoreAcc2gmTest, case_nchw_7) { test_tstore_acc2gm_vector_nz2nd<42, float, uint16_t, 256, 128, 32>(); }
TEST_F(TStoreAcc2gmTest, case_ncdhw_1) { test_tstore_acc2gm_nz2nd<51, float, float, 256, 128, 16>(); }
TEST_F(TStoreAcc2gmTest, case_ncdhw_2) { test_tstore_acc2gm_nz2nd<52, uint32_t, uint8_t, 1536, 63, 31>(); }
TEST_F(TStoreAcc2gmTest, case_ncdhw_3) { test_tstore_acc2gm_nz2nd<53, uint16_t, float, 4096, 32, 8>(); }
TEST_F(TStoreAcc2gmTest, case_ncdhw_4) { test_tstore_acc2gm_nz2nd<54, float, uint16_t, 252, 43, 64>(); }
TEST_F(TStoreAcc2gmTest, case_ncdhw_5) { test_tstore_acc2gm_scalar_nz2nd<51, uint8_t, uint8_t, 2560, 64, 96>(3); }
