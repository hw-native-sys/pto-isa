    ...
    using GlobalDataOut = std::conditional_t<
        ...
        std::conditional_t<
            ...
            std::conditional_t<
                ...
                std::conditional_t<
                    (format == 3), GlobalTensor<dstDataType, DynShapeDim5, DynStridDim5, Layout::NCDHW>,
...
void LaunchTStoreAcc2gmScalarNz2nd(uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant)
{
    if constexpr (tilingKey == 1) {
        ...
        TStoreAcc2gmScalarNz2nd<0, float, float8_e4m3_t, float8_e4m3_t, 1, 1, 1, 32, 32, 1, 1, 1, 32, 32, 32, 32, 31>
            <<<1, nullptr, stream>>>(
                reinterpret_cast<float8_e4m3_t*>(out), reinterpret_cast<float8_e4m3_t*>(src0),
        ...
        TStoreAcc2gmScalarNz2nd<0, float, int8_t, hifloat8_t, 1, 8, 16, 5, 64, 1, 8, 16, 5, 64, 640, 64, 96, 1, 1>
            <<<1, nullptr, stream>>>(
                reinterpret_cast<int8_t*>(out), reinterpret_cast<hifloat8_t*>(src0),
...
void LaunchTStoreAcc2gmVectorNz2nd(uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream)
{
    if constexpr (tilingKey == 1) {
        ...
        TStoreAcc2gmVectorNz2nd<0, float, half, float8_e4m3_t, 1, 2, 8, 22, 64, 1, 2, 8, 22, 64, 352, 64, 32, 0, 1>
            <<<1, nullptr, stream>>>(
                reinterpret_cast<half*>(out), reinterpret_cast<float8_e4m3_t*>(src0),
...
template void LaunchTStoreAcc2gmScalarNz2nd<5>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant);
template void LaunchTStoreAcc2gmScalarNz2nd<6>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant);
template void LaunchTStoreAcc2gmScalarNz2nd<7>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant);
template void LaunchTStoreAcc2gmScalarNz2nd<8>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant);
template void LaunchTStoreAcc2gmScalarNz2nd<9>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant);
template void LaunchTStoreAcc2gmScalarNz2nd<10>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant);
...
template void LaunchTStoreAcc2gmScalarNz2nz<5>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant);
template void LaunchTStoreAcc2gmScalarNz2nz<6>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant);
template void LaunchTStoreAcc2gmScalarNz2nz<7>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant);
template void LaunchTStoreAcc2gmScalarNz2nz<8>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant);
template void LaunchTStoreAcc2gmScalarNz2nz<9>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant);
...
template void LaunchTStoreAcc2gmVectorNz2nd<5>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2nd<6>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
...
template void LaunchTStoreAcc2gmVectorNz2nz<4>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2nz<5>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2nz<6>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2nz<7>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2nz<8>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2nz<9>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
...
template void LaunchTStoreAcc2gmScalarNz2nd<41>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant);
template void LaunchTStoreAcc2gmScalarNz2nd<51>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream, float scalarQuant);
template void LaunchTStoreAcc2gmVectorNz2nd<41>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2nd<42>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2nd<51>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
template void LaunchTStoreAcc2gmVectorNz2nd<52>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, uint8_t* quantTensor, void* stream);
