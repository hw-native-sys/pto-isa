...
template void launchTLOADMX<uint8_t, 3, 1, 1, 1, 116, 34, 1, 1, 1, 130, 60, 128, 64>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream);
// 4:AZZ2ZZ
template void launchTLOADMX<uint8_t, 4, 1, 1, 1, 16, 4, 1, 1, 1, 16, 4, 16, 4>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream);
template void launchTLOADMX<uint8_t, 4, 1, 1, 1, 80, 66, 1, 1, 1, 176, 80, 128, 96>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream);
// 5:BNN2NN
template void launchTLOADMX<uint8_t, 5, 1, 1, 1, 4, 64, 1, 1, 1, 4, 64, 4, 64>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream);
template void launchTLOADMX<uint8_t, 5, 1, 1, 1, 58, 1024, 1, 1, 1, 58, 1040, 58, 1088>(
    uint8_t* out, uint8_t* src0, uint8_t* src1, void* stream);
