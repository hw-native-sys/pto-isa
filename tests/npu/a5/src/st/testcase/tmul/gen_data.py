...
if __name__ == "__main__":
    ...
    case_params_list = [
        TMulParams(np.float32, 64, 64, 64, 64, 64, 64, 64, 64),
        TMulParams(np.int32, 64, 64, 64, 64, 64, 64, 64, 64),
        TMulParams(np.int16, 64, 64, 64, 64, 64, 64, 64, 64),
        TMulParams(np.float16, 16, 256, 16, 256, 16, 256, 16, 256),
        TMulParams(np.float16, 16, 64, 16, 128, 16, 128, 16, 64),
        TMulParams(np.float32, 16, 32, 16, 64, 16, 32, 16, 32),
        TMulParams(np.int16, 32, 128, 32, 128, 32, 256, 32, 128),
        TMulParams(np.int32, 16, 32, 16, 64, 16, 32, 16, 32),
        TMulParams(np.float16, 16, 64, 16, 128, 16, 128, 16, 63),
        ...
        TMulParams(np.int64, 4, 16, 4, 16, 4, 16, 4, 16),
        TMulParams(np.uint64, 4, 16, 4, 16, 4, 16, 4, 16),
    ]
