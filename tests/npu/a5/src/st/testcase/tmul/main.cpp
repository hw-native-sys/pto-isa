...
template <typename T>
void CheckTMulResult(size_t fileSizeDst)
{
...
TEST_F(TMULTest, case_int64_4x16_4x16_4x16_4x16) { test_tmul<int64_t, 4, 16, 4, 16, 4, 16, 4, 16>(); }
TEST_F(TMULTest, case_uint64_4x16_4x16_4x16_4x16) { test_tmul<uint64_t, 4, 16, 4, 16, 4, 16, 4, 16>(); }
