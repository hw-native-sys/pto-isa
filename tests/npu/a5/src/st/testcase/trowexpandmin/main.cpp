...
TEST_F(TRowExpandMinTest, case_int64_16_32) { test_trowexpandmin<int64_t, 16, 32, 16, 1, true, false>(); }
TEST_F(TRowExpandMinTest, case_int64_24_64) { test_trowexpandmin<int64_t, 24, 64, 24, 4, true, true>(); }
TEST_F(TRowExpandMinTest, case_uint64_16_32) { test_trowexpandmin<uint64_t, 16, 32, 16, 1, true, false>(); }
} // namespace TRowExpandMinTest
