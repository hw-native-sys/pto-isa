...
template void launchTRowExpandMin<aclFloat16, 48, 64, 48, 1, true>(
    aclFloat16* out, aclFloat16* src0, aclFloat16* src1, void* stream);
template void launchTRowExpandMin<aclFloat16, 16, 128, 16, 1, true>(
    aclFloat16* out, aclFloat16* src0, aclFloat16* src1, void* stream);
template void launchTRowExpandMin2<float, 24, 64, 24, 8, true>(float* out, float* src0, float* src1, void* stream);
template void launchTRowExpandMin<aclFloat16, 32, 64, 32, 1, false>(
    aclFloat16* out, aclFloat16* src0, aclFloat16* src1, void* stream);
template void launchTRowExpandMin2<float, 20, 64, 20, 8, false>(float* out, float* src0, float* src1, void* stream);
template void launchTRowExpandMin<int32_t, 16, 32, 16, 1, true>(
    int32_t* out, int32_t* src0, int32_t* src1, void* stream);
template void launchTRowExpandMin<int16_t, 16, 64, 16, 1, true>(
    int16_t* out, int16_t* src0, int16_t* src1, void* stream);
template void launchTRowExpandMin<int64_t, 16, 32, 16, 1, true>(
    int64_t* out, int64_t* src0, int64_t* src1, void* stream);
template void launchTRowExpandMin2<int64_t, 24, 64, 24, 4, true>(
    int64_t* out, int64_t* src0, int64_t* src1, void* stream);
template void launchTRowExpandMin<uint64_t, 16, 32, 16, 1, true>(
