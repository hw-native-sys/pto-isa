...
__global__ AICORE void runTShl(__gm__ T __out__* out, __gm__ T __in__* src0, __gm__ T __in__* src1)
{
    ...
    Event<Op::TLOAD, Op::TSHL> evt0 = TLOAD(src0Tile, src0Global);
    Event<Op::TLOAD, Op::TSHL> evt1 = TLOAD(src1Tile, src1Global);
    Event<Op::TSHL, Op::TSTORE_VEC> evt2 = TSHL(dstTile, src0Tile, src1Tile, evt0, evt1);
