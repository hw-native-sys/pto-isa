...
if __name__ == "__main__":
    ...
    case_params_list = [
        # Non-quant ND
        TStoreAcc2gmParams(np.float16, np.float16, 1, 128, 128, 16),
        TStoreAcc2gmParams(np.float16, np.float16, 1, 31, 32, 15),
        TStoreAcc2gmParams(np.float16, np.float16, 1, 65, 128, 96),
        TStoreAcc2gmParams(np.float16, np.float16, 1, 73, 64, 32),
        # Non-quant NZ
        TStoreAcc2gmParams(np.float16, np.float16, 2, 32, 64, 25),
        TStoreAcc2gmParams(np.float16, np.float16, 2, 48, 32, 45),
        TStoreAcc2gmParams(np.float16, np.float16, 2, 32, 64, 24),
        TStoreAcc2gmParams(np.float16, np.float16, 2, 96, 96, 23),
        # Special non-quant (int32 acc requires int8 src)
        TStoreAcc2gmParams(np.int32, np.int8, 1, 44, 128, 27),
        TStoreAcc2gmParams(np.int32, np.int8, 2, 64, 96, 30),
        # Scalar quant ND (half/int32 acc)
        ...
        # Scalar quant various ND
        TStoreAcc2gmParams(np.int8, np.float16, 1, 25, 35, 32, 1, 2),
        TStoreAcc2gmParams(np.uint8, np.float16, 1, 16, 20, 25, 1, 1),
        # Scalar quant various NZ
        TStoreAcc2gmParams(np.int8, np.float16, 2, 16, 64, 15, 1, 2),
        # Vector quant ND
        ...
        # relu
        TStoreAcc2gmParams(np.float16, np.float16, 1, 117, 97, 71, relu_mode=1),
        TStoreAcc2gmParams(np.float16, np.float16, 2, 160, 80, 51, relu_mode=1),
