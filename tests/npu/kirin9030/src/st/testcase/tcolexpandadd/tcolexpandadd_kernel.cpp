...
__global__ AICORE void runCOLEXPANDADD(__gm__ T* out, __gm__ T* src0, __gm__ T* src1)
{
    ...
    TASSIGN<DstTileData::Numel * sizeof(T)>(dstTile);
    TASSIGN<2 * DstTileData::Numel * sizeof(T)>(src1Tile);
