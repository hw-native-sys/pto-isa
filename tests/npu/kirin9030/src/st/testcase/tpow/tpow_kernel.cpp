...
__global__ AICORE void runTPow(__gm__ T *out, __gm__ T *base, __gm__ T *exp)
{
    ...
    Event<Op::TPOW, Op::TSTORE_VEC> evt2 = TPOW(dstTile, baseTile, expTile, tmpTile, evt0, evt1);
