...
def gen_golden(case_name, rows, cols):
    input_arr = np.random.randint(-127, 128, size=(rows, cols), dtype=np.int8)
...
if __name__ == "__main__":
    case_name_list = ["TMovNd2NzTest.case_int8_32x32", "TMovNd2NzTest.case_int8_32x64", "TMovNd2NzTest.case_int8_64x64"]
