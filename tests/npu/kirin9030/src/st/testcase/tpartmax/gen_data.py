...
if __name__ == "__main__":
    ...
    case_params_list = [
        ...
        TPartMaxParams(np.float32, 61, 123, 52, 123, 61, 123),
        TPartMaxParams(np.float16, 61, 123, 52, 123, 61, 123),
        TPartMaxParams(np.int8, 61, 123, 52, 123, 61, 123),
        TPartMaxParams(np.int16, 61, 123, 52, 123, 61, 123),
        TPartMaxParams(np.int32, 61, 123, 52, 123, 61, 123),
        TPartMaxParams(np.uint8, 61, 123, 52, 123, 61, 123),
        TPartMaxParams(np.uint16, 61, 123, 52, 123, 61, 123),
        TPartMaxParams(np.uint32, 61, 123, 52, 123, 61, 123),
