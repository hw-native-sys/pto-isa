...
__global__ AICORE void runTConcat(
    __gm__ dataType* out, __gm__ dataType* src0, __gm__ dataType* src1, __gm__ idxType* src0Idx,
    __gm__ idxType* src1Idx)
{
    ...
    constexpr int src1Tileoffset = TileDataSrc0::Numel * sizeof(dataType);
    constexpr int dstTileoffset = src1Tileoffset + TileDataSrc1::Numel * sizeof(dataType);
    constexpr int src0IdxTileoffset = dstTileoffset + TileDataDst::Numel * sizeof(dataType);
    constexpr int src1IdxTileoffset = src0IdxTileoffset + TileDataSrc0Idx::Numel * sizeof(idxType);
    TASSIGN<0x0>(src0Tile);
    TASSIGN<src1Tileoffset>(src1Tile);
    TASSIGN<dstTileoffset>(dstTile);
    TASSIGN<src0IdxTileoffset>(src0IdxTile);
    TASSIGN<src1IdxTileoffset>(src1IdxTile);
...
void LaunchTConcatHalf(
    aclFloat16* out, aclFloat16* src0, aclFloat16* src1, idxType* src0Idx, idxType* src1Idx, void* stream)
{
...
template void LaunchTConcat<int32_t, int16_t, 64, 128, 64, 64, 64, 64, 64, 64, 64>(
    int32_t* out, int32_t* src0, int32_t* src1, int16_t* src0Idx, int16_t* src1Idx, void* stream);
