...
TEST_F(TMOVTest, case_nz2nz_2) { tmov_acc2mat_test<1, uint16_t, uint16_t, uint16_t, 2>(128, 64, 128); }

TEST_F(TMOVTest, case_nz2nz_3) { tmov_acc2mat_test<1, uint16_t, uint16_t, uint16_t, 3>(16, 16, 16); }
...
TEST_F(TMOVTest, case_nz2nd_2) { tmov_acc2mat_test<2, uint16_t, uint16_t, uint16_t, 2>(111, 48, 88); }

TEST_F(TMOVTest, case_nz2nd_3) { tmov_acc2mat_test<2, uint16_t, uint16_t, uint16_t, 3>(80, 128, 112); }

TEST_F(TMOVTest, case_nz2nd_4) { tmov_acc2mat_test<2, uint16_t, uint16_t, uint16_t, 4>(6, 7, 8); }
