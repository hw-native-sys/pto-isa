...
if __name__ == "__main__":
    cases = [
        ...
        ("TInsertTest.case_nz_twoinput_fp32_2", gen_twoinput, TwoInputParams(4, 128, 1, 0, 128, 256, 128)),
        ...
        (
            ...
            gen_double_twoinput,
            DoubleTwoInputParams(2, 1, 128, 128, 0, 129, 256, 128),
        ),
        (
        ...
        (
            ...
            gen_double_twoinput,
            DoubleTwoInputParams(4, 1, 128, 128, 0, 129, 256, 64),
        ),
        (
        ...
        (
            "TInsertTest.case_compact_null_tload_f16_unaligned_idx0_16",
            gen_compact_null_tload,
