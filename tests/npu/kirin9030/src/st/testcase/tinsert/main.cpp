...
{
    testTInsertAcc2Mat<1, uint16_t, uint16_t>(16, 16, 16);
}
TEST_F(TInsertTest, case_acc2mat_2)
{
    testTInsertAcc2Mat<2, uint16_t, uint16_t>(32, 32, 32);
}
...
{
    testTInsertNZTwoInput<10, float, 129, 256, 128>();
}
...
{
    testTInsertNZDoubleInput<13, uint16_t, 129, 256, 128>();
}
TEST_F(TInsertTest, case_nz_dblinput_fp32_2)
{
    testTInsertNZDoubleInput<15, float, 129, 256, 64>();
}
