...
TEST_F(TInsertTest, case_nz_twoinput_fp32_2) { testTInsertNZTwoInput<10, float, 129, 256, 128>(); }
...
TEST_F(TInsertTest, case_nz_dblinput_fp16_2) { testTInsertNZDoubleInput<13, uint16_t, 129, 256, 128>(); }
TEST_F(TInsertTest, case_nz_dblinput_fp32_2) { testTInsertNZDoubleInput<15, float, 129, 256, 64>(); }
...
TEST_F(TInsertTest, case_compact_null_tload_f16_unaligned_idx0_16)
{
