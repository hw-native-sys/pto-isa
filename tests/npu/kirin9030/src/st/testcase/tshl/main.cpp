...
class TSHLTest : public testing::Test {
protected:
    void SetUp() override {}
...
void test_tshl()
{
    ...
    LaunchTShl<T, kTRows_, kTCols_, vRows, vCols>(dstDevice, src0Device, src1Device, stream);
...
TEST_F(TSHLTest, case5) { test_tshl<uint8_t, 32, 32, 32, 32>(); }

TEST_F(TSHLTest, case6) { test_tshl<uint32_t, 8, 8, 8, 8>(); }

TEST_F(TSHLTest, case7) { test_tshl<int8_t, 32, 32, 32, 32>(); }
