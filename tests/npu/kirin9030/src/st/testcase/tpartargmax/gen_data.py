...
def generate_case_name(param):
    ...
    return (f"TPARTARGMAXTest.case_{dtype_str}_{param.dst_vr}x{param.dst_vc}_{param.src0_vr}x{param.src0_vc}_"
...
if __name__ == "__main__":
    ...
    for param in case_params_list:
        ...
        os.chdir(case_name)
        gen_golden_data_tpartargmax(case_name, param)
