...
if __name__ == "__main__":
    ...
    case_params_list = [
        ...
        TSubParams(np.uint32, 64, 64, 64, 64, 64, 64, 64, 64),
        TSubParams(np.uint32, 16, 32, 16, 64, 16, 32, 16, 32),
        TSubParams(np.uint32, 16, 32, 16, 64, 16, 32, 16, 31),
        TSubParams(np.uint16, 64, 64, 64, 64, 64, 64, 64, 64),
        TSubParams(np.uint16, 32, 128, 32, 128, 32, 256, 32, 128),
        TSubParams(np.uint16, 32, 128, 32, 128, 32, 256, 32, 127),
        TSubParams(np.int8, 64, 64, 64, 64, 64, 64, 64, 64),
        TSubParams(np.int8, 32, 256, 32, 256, 32, 512, 32, 256),
        TSubParams(np.int8, 32, 256, 32, 256, 32, 512, 32, 255),
        TSubParams(np.uint8, 64, 64, 64, 64, 64, 64, 64, 64),
        TSubParams(np.uint8, 32, 256, 32, 256, 32, 512, 32, 256),
        TSubParams(np.uint8, 32, 256, 32, 256, 32, 512, 32, 255),
        TSubParams(np.float32, 16, 16, 16, 48, 16, 16, 16, 15),
        TSubParams(np.int32, 16, 16, 16, 48, 16, 16, 16, 15),
        TSubParams(np.uint32, 16, 16, 16, 48, 16, 16, 16, 15),
        TSubParams(np.float16, 16, 32, 16, 96, 16, 32, 16, 31),
        TSubParams(np.int16, 16, 32, 16, 96, 16, 32, 16, 31),
        TSubParams(np.uint16, 16, 32, 16, 96, 16, 32, 16, 31),
        TSubParams(np.int8, 32, 128, 32, 160, 32, 128, 32, 127),
        TSubParams(np.uint8, 32, 128, 32, 160, 32, 128, 32, 127),
    ]
