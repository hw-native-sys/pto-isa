...
class TRowArgMinParams:
    ...
    def __init__(
        self, dst_dtype, src_dtype, dst_tile_row, dst_tile_col, src_tile_row, src_tile_col, valid_row, valid_col
    ):
        ...
        self.name = (
            f"TROWARGMINTest.case_{self.DTYPE_STR_TABLE[dst_dtype]}_{self.DTYPE_STR_TABLE[src_dtype]}_"
...
class TRowArgMinValIdxParams(TRowArgMinParams):
    def __init__(
        ...
        super().__init__(
            dst_dtype, src_dtype, dst_tile_row, dst_tile_col, src_tile_row, src_tile_col, valid_row, valid_col
        )
