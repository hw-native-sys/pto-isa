...
AICORE inline void test_copy_ubuf_to_cbuf(
    __cbuf__ void* dst, __ubuf__ void* src, uint8_t sid, uint16_t nBurst, uint16_t lenBurst, uint16_t srcGap,
    uint16_t dstGap)
{
    constexpr uint32_t CBUF_UB_BURST_UNIT = 32;
    uint16_t loop2SrcStride = static_cast<uint16_t>(lenBurst + srcGap);
...
AICORE void runTInsertNZ(__gm__ T* out, __gm__ T* src)
{
    ...
    test_copy_cbuf_to_ubuf((__ubuf__ void*)dstUbAddr, (__cbuf__ void*)matAddr, 0, burstNum, burstLen, srcGap, 0);
...
AICORE void runTInsertNZPlusOne(__gm__ T* out, __gm__ T* src)
{
    ...
    set_flag(PIPE_MTE3, PIPE_FIX, EVENT_ID0);
    wait_flag(PIPE_MTE3, PIPE_FIX, EVENT_ID0);
    test_copy_cbuf_to_ubuf((__ubuf__ void*)dstUbAddr, (__cbuf__ void*)matAddr, 0, burstNum, burstLen, 0, 0);
    set_flag(PIPE_FIX, PIPE_MTE3, EVENT_ID0);
    wait_flag(PIPE_FIX, PIPE_MTE3, EVENT_ID0);
    TSTORE(dstGlobal, dstTile);
}
...
AICORE void runTInsertNZLargeTile(__gm__ T* out, __gm__ T* src)
{
    ...
    set_flag(PIPE_V, PIPE_MTE3, EVENT_ID0);
    wait_flag(PIPE_V, PIPE_MTE3, EVENT_ID0);
    test_copy_ubuf_to_cbuf(matAddr, dstUbAddr, 0, burstNum, burstLen, 0, 0);
...
AICORE void runTInsertNZTwoInputSplit(__gm__ T* out, __gm__ T* src)
{
    ...
    constexpr uint32_t burstNum = Cols / c0Size;
    constexpr uint16_t burstLen = (DstRows * c0Size * sizeof(T)) / BLOCK_BYTE_SIZE;
    constexpr uint32_t burstLenBytes = DstRows * c0Size * sizeof(T);
    ...
    pto_copy_gm_to_ubuf_align_v2(
        (__ubuf__ uint8_t*)ubAddr, (__gm__ uint8_t*)src, 0, burstNum, burstLenBytes, 0, 0, false, 0, burstLenBytes,
        burstLenBytes);
    set_flag(PIPE_MTE2, PIPE_MTE3, EVENT_ID0);
    wait_flag(PIPE_MTE2, PIPE_MTE3, EVENT_ID0);
    test_copy_ubuf_to_cbuf(matAddr, ubAddr, 0, burstNum, burstLen, 0, 0);
    set_flag(PIPE_MTE3, PIPE_MTE2, EVENT_ID0);
    wait_flag(PIPE_MTE3, PIPE_MTE2, EVENT_ID0);
    // Load NZ data from GM to UB (MTE2) — overwrites zeros in UB
    pto_copy_gm_to_ubuf_align_v2(
        (__ubuf__ uint8_t*)ubAddr, (__gm__ uint8_t*)nz1GmAddr, 0, 1, nz1TotalBytes, 0, 0, false, 0, 0, 0);
    set_flag(PIPE_MTE2, PIPE_MTE3, EVENT_ID0);
    wait_flag(PIPE_MTE2, PIPE_MTE3, EVENT_ID0);
    TINSERT<Mode>(matTile, srcTile);
    set_flag(PIPE_MTE3, PIPE_FIX, EVENT_ID0);
    wait_flag(PIPE_MTE3, PIPE_FIX, EVENT_ID0);
    test_copy_cbuf_to_ubuf(ubAddr, matAddr, 0, burstNum, burstLen, 0, 0);
    set_flag(PIPE_FIX, PIPE_MTE3, EVENT_ID0);
    wait_flag(PIPE_FIX, PIPE_MTE3, EVENT_ID0);
    TSTORE(dstGlobal, dstTile);
}
...
AICORE void runTInsertNZDoubleInput(__gm__ T* out, __gm__ T* src)
{
    ...
    // Load zero_region from GM to UB, then copy to L1 to initialize L1 with zeros
    pto_copy_gm_to_ubuf_align_v2(
        (__ubuf__ uint8_t*)ubAddr1, (__gm__ uint8_t*)src, 0, burstNum, burstLenBytes, 0, 0, false, 0, burstLenBytes,
        burstLenBytes);
    set_flag(PIPE_MTE2, PIPE_MTE3, EVENT_ID0);
    wait_flag(PIPE_MTE2, PIPE_MTE3, EVENT_ID0);
    test_copy_ubuf_to_cbuf(matAddr, ubAddr1, 0, burstNum, burstLen, 0, 0);
    set_flag(PIPE_MTE3, PIPE_MTE2, EVENT_ID0);
    wait_flag(PIPE_MTE3, PIPE_MTE2, EVENT_ID0);
    // Load NZ data for both tiles from GM to UB (MTE2) — overwrites zeros in UB
    pto_copy_gm_to_ubuf_align_v2(
        (__ubuf__ uint8_t*)ubAddr1, (__gm__ uint8_t*)nz1Addr1, 0, 1, nz1TotalBytes, 0, 0, false, 0, 0, 0);
    pto_copy_gm_to_ubuf_align_v2(
        (__ubuf__ uint8_t*)ubAddr2, (__gm__ uint8_t*)nz1Addr2, 0, 1, nz1TotalBytes, 0, 0, false, 0, 0, 0);
    set_flag(PIPE_MTE2, PIPE_MTE3, EVENT_ID0);
    wait_flag(PIPE_MTE2, PIPE_MTE3, EVENT_ID0);
    ...
    set_flag(PIPE_MTE3, PIPE_FIX, EVENT_ID0);
    wait_flag(PIPE_MTE3, PIPE_FIX, EVENT_ID0);
    test_copy_cbuf_to_ubuf(ubAddr1, matAddr, 0, burstNum, burstLen, 0, 0);
    set_flag(PIPE_FIX, PIPE_MTE3, EVENT_ID0);
    wait_flag(PIPE_FIX, PIPE_MTE3, EVENT_ID0);
    TSTORE(dstGlobal, dstTile);
}
...
AICORE void runTInsertCompactNullTLoad(__gm__ T* out, __gm__ T* src)
{
    ...
    constexpr uint32_t initBurstLenBytes = DstRows * c0Size * sizeof(T);
    ...
    pto_copy_gm_to_ubuf_align_v2(
        (__ubuf__ uint8_t*)dstUbAddr, (__gm__ uint8_t*)src, 0, initBurstNum, initBurstLenBytes, 0, 0, false, 0,
        initBurstLenBytes, initBurstLenBytes);
    set_flag(PIPE_MTE2, PIPE_MTE3, EVENT_ID0);
    wait_flag(PIPE_MTE2, PIPE_MTE3, EVENT_ID0);
    test_copy_ubuf_to_cbuf(matAddr, dstUbAddr, 0, initBurstNum, initBurstLen, 0, 0);
    ...
    set_flag(PIPE_MTE3, PIPE_FIX, EVENT_ID0);
    wait_flag(PIPE_MTE3, PIPE_FIX, EVENT_ID0);
    test_copy_cbuf_to_ubuf(dstUbAddr, matAddr, 0, initBurstNum, initBurstLen, 0, 0);
    set_flag(PIPE_FIX, PIPE_MTE3, EVENT_ID0);
    wait_flag(PIPE_FIX, PIPE_MTE3, EVENT_ID0);
    TSTORE(dstGlobal, dstTile);
}
