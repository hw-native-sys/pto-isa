...
template <
    typename Src0GlobalData, typename Src1GlobalData, typename DstTileData, typename TmpTileData, typename TileData,
    typename T, bool EXHAUSTED>
PTO_INTERNAL void Sort2Lists(
    DstTileData& dstTile, Src0GlobalData& src0Global, Src1GlobalData& src1Global, TileData& src0Tile,
...
template <
    typename Src0GlobalData, typename Src1GlobalData, typename Src2GlobalData, typename DstTileData,
    typename TmpTileData, typename TileData, typename T, bool EXHAUSTED>
PTO_INTERNAL void Sort3Lists(
    DstTileData& dstTile, Src0GlobalData& src0Global, Src1GlobalData& src1Global, Src2GlobalData& src2Global,
    TileData& src0Tile, TileData& src1Tile, TileData& src2Tile, TmpTileData& tmpTile)
{
    MrgSortExecutedNumList executedNumList;
    TLOAD(src0Tile, src0Global);
    TLOAD(src1Tile, src1Global);
...
template <
    typename Src0GlobalData, typename Src1GlobalData, typename Src2GlobalData, typename Src3GlobalData,
    typename DstTileData, typename TmpTileData, typename TileData, typename T, bool EXHAUSTED>
PTO_INTERNAL void Sort4Lists(
    DstTileData& dstTile, Src0GlobalData& src0Global, Src1GlobalData& src1Global, Src2GlobalData& src2Global,
    Src3GlobalData& src3Global, TileData& src0Tile, TileData& src1Tile, TileData& src2Tile, TileData& src3Tile,
    TmpTileData& tmpTile)
{
    MrgSortExecutedNumList executedNumList;
    TLOAD(src0Tile, src0Global);
...
__global__ AICORE void RunTMrgsort(__gm__ T* out, __gm__ T* src0, __gm__ T* src1, __gm__ T* src2, __gm__ T* src3)
{
    ...
    if constexpr (LISTNUM == 4) {
        Sort4Lists<
            Src0GlobalData, Src1GlobalData, Src2GlobalData, Src3GlobalData, DstTileData, TmpTileData, TileData, T,
            EXHAUSTED>(
...
template <
    typename GlobalData, typename DstGlobalData, typename DstTileData, typename TileData, typename TmpTileData,
...
void LanchTMrgsortMulti(float* out, float* src0, float* src1, float* src2, float* src3, void* stream)
{
    if constexpr (std::is_same_v<T, uint16_t>) {
        ...
        RunTMrgsort<
            half, kGRows_, kGCols_ * TYPE_COEF, kTRows_, kTCols_ * TYPE_COEF, kTCols_src1 * TYPE_COEF,
