...
TEST_F(TRowExpandMaxTest, case_fp32_16_32) { test_trowexpandmax<float, 16, 32, 16, 1, true, false>(); }
TEST_F(TRowExpandMaxTest, case_fp32_56_128) { test_trowexpandmax<float, 56, 128, 56, 1, true, false>(); }
TEST_F(TRowExpandMaxTest, case_fp16_48_64) { test_trowexpandmax<aclFloat16, 48, 64, 48, 1, true, false>(); }
TEST_F(TRowExpandMaxTest, case_fp16_16_128) { test_trowexpandmax<aclFloat16, 16, 128, 16, 1, true, false>(); }
TEST_F(TRowExpandMaxTest, case_fp32_24_64) { test_trowexpandmax<float, 24, 64, 24, 8, true, true>(); }
TEST_F(TRowExpandMaxTest, case_fp16_32_64) { test_trowexpandmax<aclFloat16, 32, 64, 32, 1, false, false>(); }
