...
// FP32 Source → fp16, bf16, int16, int32, fp8 variants (int64 not supported on kirinDev0000)
GENERATE_TCVT_TESTS(aclFloat16, float, fp32_fp16)
GENERATE_TCVT_TESTS(bf16_wrapper, float, fp32_bf16)
...
GENERATE_TCVT_TESTS(int32_t, bf16_wrapper, bf16_int32)
...
// I32 Source → float, int16, uint16, uint8 (int64 not supported on kirinDev0000)
...
// I64 Source → float, int32 (not supported on kirinDev0000)
