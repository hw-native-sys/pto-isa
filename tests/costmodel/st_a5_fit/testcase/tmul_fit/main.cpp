...
void runTMul()
{
    pto::test::ExpectA5CycleNear("TMUL", TMulInput<T, Rows, Cols, ValidRows, ValidCols, VfImplKindValue>(), Profiling,
                                 Precision);
}
...
TEST(A5TMulFit, Fp16ReusesFp32Curve)
{
    runTMul<half, 1, 1280, 68.0, 1.0000>();
}
