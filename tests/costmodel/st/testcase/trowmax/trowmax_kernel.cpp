...
template void LaunchTRowMax<float, 64, 64, 64, 64, 13.0f, 1.0f>(float *out, float *src, void *stream);
template void LaunchTRowMax<float, 16, 256, 16, 256, 68.0f, 1.0f>(float *out, float *src, void *stream);
template void LaunchTRowMax<aclFloat16, 64, 128, 64, 128, 13.0f, 1.0f>(aclFloat16 *out, aclFloat16 *src, void *stream);
template void LaunchTRowMax<aclFloat16, 16, 256, 16, 256, 32.0f, 1.0f>(aclFloat16 *out, aclFloat16 *src, void *stream);
