...
__global__ AICORE void runTINTERLEAVE(__gm__ T __out__ *dst1, __gm__ T __out__ *dst0, __gm__ T __in__ *src1,
...
template void LaunchTINTERLEAVE<int32_t, 16, 64>(int32_t *dst1, int32_t *dst0, int32_t *src1, int32_t *src0,
                                                 void *stream);
template void LaunchTINTERLEAVE<int16_t, 32, 128>(int16_t *dst1, int16_t *dst0, int16_t *src1, int16_t *src0,
                                                  void *stream);
template void LaunchTINTERLEAVE<aclFloat16, 20, 16>(aclFloat16 *dst1, aclFloat16 *dst0, aclFloat16 *src1,
