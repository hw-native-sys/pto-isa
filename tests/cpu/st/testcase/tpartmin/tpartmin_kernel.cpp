...
template void LaunchTPARTMIN<int64_t, kRows, kCols, kValidRows1, kValidCols1>(
    int64_t* out, int64_t* src0, int64_t* src1, void* stream);
template void LaunchTPARTMIN<uint64_t, kRows, kCols, kValidRows1, kValidCols1>(
    uint64_t* out, uint64_t* src0, uint64_t* src1, void* stream);
template void LaunchTPARTMIN<int16_t, kRows, kCols, kValidRows1, kValidCols1>(
    int16_t* out, int16_t* src0, int16_t* src1, void* stream);
template void LaunchTPARTMIN<uint16_t, kRows, kCols, kValidRows1, kValidCols1>(
    uint16_t* out, uint16_t* src0, uint16_t* src1, void* stream);
template void LaunchTPARTMIN<int32_t, kRows, kCols, kValidRows1, kValidCols1>(
    int32_t* out, int32_t* src0, int32_t* src1, void* stream);
template void LaunchTPARTMIN<uint32_t, kRows, kCols, kValidRows1, kValidCols1>(
