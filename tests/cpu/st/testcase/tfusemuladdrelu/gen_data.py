...
class TestParams:
    def __init__(self, dtype, dst_tile_row, dst_tile_col, src0_tile_row, src0_tile_col,
        ...
        self.name = f"TFUSEMULADDRELUTest.case_{dtype_str}_{dst_tile_row}x{dst_tile_col}_\
