...
class TFUSEMULADDTest : public testing::Test {
protected:
    void SetUp() override {}
...
void test_TFUSEMULADD()
{
    ...
    LaunchTFUSEMULADD<T, dstTileH, dstTileW, src0TileH, src0TileW, src1TileH, src1TileW, vRows, vCols>(
...
TEST_F(TFUSEMULADDTest, case_float_64x64_64x64_64x64_64x64)
{
    test_TFUSEMULADD<float, 64, 64, 64, 64, 64, 64, 64, 64>();
}
TEST_F(TFUSEMULADDTest, case_float_32x128_32x192_32x256_32x127)
{
    test_TFUSEMULADD<float, 32, 128, 32, 192, 32, 256, 32, 127>();
}
TEST_F(TFUSEMULADDTest, case_half_64x64_64x64_64x64_64x64)
{
    test_TFUSEMULADD<aclFloat16, 64, 64, 64, 64, 64, 64, 64, 64>();
}
TEST_F(TFUSEMULADDTest, case_half_32x128_32x192_32x256_32x127)
{
    test_TFUSEMULADD<aclFloat16, 32, 128, 32, 192, 32, 256, 32, 127>();
}
