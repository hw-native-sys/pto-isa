...
void LaunchTAddsc(T* out, T* src0, T* scalar, T* src1, void* stream)
{
    if constexpr (std::is_same_v<T, aclFloat16>)
        runTAddsc<half, kGRows_, kGCols_, kTRows_, kTCols_>(
            (half*)(out), (half*)(src0), (half*)(scalar), (half*)(src1));
    else
...
template void LaunchTAddsc<int32_t, NUM_64, NUM_64, NUM_64, NUM_64>(
    int32_t* out, int32_t* src0, int32_t* scalar, int32_t* src1, void* stream);
template void LaunchTAddsc<aclFloat16, NUM_16, NUM_256, NUM_16, NUM_256>(
    aclFloat16* out, aclFloat16* src0, aclFloat16* scalar, aclFloat16* src1, void* stream);
template void LaunchTAddsc<int16_t, NUM_64, NUM_64, NUM_64, NUM_64>(
    int16_t* out, int16_t* src0, int16_t* scalar, int16_t* src1, void* stream);
#ifdef CPU_SIM_BFLOAT_ENABLED
template void LaunchTAddsc<bfloat16_t, NUM_16, NUM_256, NUM_16, NUM_256>(
    bfloat16_t* out, bfloat16_t* src0, bfloat16_t* scalar, bfloat16_t* src1, void* stream);
#endif
