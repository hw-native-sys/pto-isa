...
void launchTXOR_demo(uint8_t* out, uint8_t* src, void* stream);
...
void test_txor()
{
    ...
    LaunchTXOR<T, kGRows_, kGCols_, kTRows_, kTCols_>(dstDevice, src0Device, src1Device, stream);
...
TEST_F(TXORTest, case_int16_64x64_64x64_64x64) { test_txor<int16_t, NUM_64, NUM_64, NUM_64, NUM_64>(); }
TEST_F(TXORTest, case_int32_16x256_16x256_16x256) { test_txor<int32_t, NUM_16, NUM_256, NUM_16, NUM_256>(); }
