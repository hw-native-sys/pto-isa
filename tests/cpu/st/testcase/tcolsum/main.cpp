...
TEST_F(TCOLSUMTest, case_float_64x64_64x64_64x64) { test_tcolsum<float, 64, 64, 64, 64>(); }
TEST_F(TCOLSUMTest, case_half_16x256_16x256_16x256) { test_tcolsum<aclFloat16, 16, 256, 16, 256>(); }
