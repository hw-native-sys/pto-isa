...
template void LaunchTSubc<aclFloat16, NUM_16, NUM_256, NUM_16, NUM_256>(
    aclFloat16* out, aclFloat16* src0, aclFloat16* src1, aclFloat16* src2, void* stream);
template void LaunchTSubc<int16_t, NUM_64, NUM_64, NUM_64, NUM_64>(
    int16_t* out, int16_t* src0, int16_t* src1, int16_t* src2, void* stream);
#ifdef CPU_SIM_BFLOAT_ENABLED
template void LaunchTSubc<bfloat16_t, NUM_16, NUM_256, NUM_16, NUM_256>(
