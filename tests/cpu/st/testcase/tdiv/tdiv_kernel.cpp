...
template void LaunchTDiv<aclFloat16, 16, 256, 16, 256>(
...
template void LaunchTDiv<int64_t, 64, 64, 64, 64>(int64_t* out, int64_t* src0, int64_t* src1, void* stream);
#ifdef CPU_SIM_BFLOAT_ENABLED
template void LaunchTDiv<bfloat16_t, 16, 256, 16, 256>(
