...
template <typename T, int kRows_, int kCols_, int kValidRows1_, int kValidCols1_>
...
void test_tpartadd()
{
    ...
    LaunchTPARTADD<T, kRows, kCols, kValidRows1, kValidCols1>(dstDevice, src0Device, src1Device, stream);
...
TEST_F(TPARTADD_Test, case_float_64x64_32x32) { test_tpartadd<float>(); }
TEST_F(TPARTADD_Test, case_int32_64x64_32x32) { test_tpartadd<int32_t>(); }
TEST_F(TPARTADD_Test, case_int64_64x64_32x32) { test_tpartadd<int64_t>(); }
TEST_F(TPARTADD_Test, case_uint64_64x64_32x32) { test_tpartadd<uint64_t>(); }
TEST_F(TPARTADD_Test, case_int16_64x64_32x32) { test_tpartadd<int16_t>(); }
TEST_F(TPARTADD_Test, case_uint16_64x64_32x32) { test_tpartadd<uint16_t>(); }
TEST_F(TPARTADD_Test, case_uint32_64x64_32x32) { test_tpartadd<uint32_t>(); }
#ifdef CPU_SIM_BFLOAT_ENABLED
TEST_F(TPARTADD_Test, case_bf16_64x64_32x32) { test_tpartadd<bfloat16_t>(); }
#endif
