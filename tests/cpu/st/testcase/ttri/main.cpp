...
TEST_F(TTRITest, case_bf16_16x256_16x256_1_0) { test_ttri<bfloat16_t, 1, 0, 16, 256, 16, 256>(); }
#endif
...
#ifdef CPU_SIM_BFLOAT_ENABLED
TEST_F(TTRITest, case_bf16_16x256_16x256_0_0) { test_ttri<bfloat16_t, 0, 0, 16, 256, 16, 256>(); }
#endif
