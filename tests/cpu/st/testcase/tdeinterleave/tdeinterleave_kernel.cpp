...
__global__ AICORE void runTDEINTERLEAVE(__gm__ T __out__ *dst1, __gm__ T __out__ *dst0, __gm__ T __in__ *src1,
...
template void LaunchTDEINTERLEAVE<int32_t, 16, 64>(int32_t *dst1, int32_t *dst0, int32_t *src1, int32_t *src0,
                                                   void *stream);
template void LaunchTDEINTERLEAVE<int16_t, 32, 128>(int16_t *dst1, int16_t *dst0, int16_t *src1, int16_t *src0,
                                                    void *stream);
template void LaunchTDEINTERLEAVE<aclFloat16, 20, 16>(aclFloat16 *dst1, aclFloat16 *dst0, aclFloat16 *src1,
                                                      aclFloat16 *src0, void *stream);
