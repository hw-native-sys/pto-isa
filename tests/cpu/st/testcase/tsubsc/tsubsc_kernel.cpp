...
void LaunchTSubsc(T* out, T* src0, T* scalar, T* src1, void* stream)
{
    if constexpr (std::is_same_v<T, aclFloat16>)
        runTSubsc<half, kGRows_, kGCols_, kTRows_, kTCols_>(
...
template void LaunchTSubsc<aclFloat16, NUM_16, NUM_256, NUM_16, NUM_256>(
    aclFloat16* out, aclFloat16* src0, aclFloat16* scalar, aclFloat16* src1, void* stream);
template void LaunchTSubsc<int16_t, NUM_64, NUM_64, NUM_64, NUM_64>(
    int16_t* out, int16_t* src0, int16_t* scalar, int16_t* src1, void* stream);
#ifdef CPU_SIM_BFLOAT_ENABLED
template void LaunchTSubsc<bfloat16_t, NUM_16, NUM_256, NUM_16, NUM_256>(
