...
{
    RunPartArgKernel<kRows, kCols, kValidRows1, kValidCols1, PartArgMinRunner>(outVal, src0Val, src1Val, outIdx,
                                                                               src0Idx, src1Idx);
}
...
template void LaunchTPARTARGMIN<64, 64, 32, 32>(float *, float *, float *, uint32_t *, uint32_t *, uint32_t *, void *);
