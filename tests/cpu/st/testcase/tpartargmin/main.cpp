...
void LaunchTPARTARGMIN(float *outVal, float *src0Val, float *src1Val, uint32_t *outIdx, uint32_t *src0Idx,
                       uint32_t *src1Idx, void *stream);

class TPARTARGMIN_Test : public testing::Test {};
...
TEST_F(TPARTARGMIN_Test, case_float_64x64_src1_32x32)
{
    ...
    RunPartArgKernelAndGetResults(LaunchTPARTARGMIN<kRows, kCols, kValidRows1, kValidCols1>, stream, dstValDevice,
