...
TEST_F(TROWPRODTest, case_float_64x64_64x64_64x64) { test_trowprod<float, 64, 64, 64, 64>(); }
TEST_F(TROWPRODTest, case_half_16x256_16x256_16x256) { test_trowprod<aclFloat16, 16, 256, 16, 256>(); }
