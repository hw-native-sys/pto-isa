...
AICORE void runTPARTMAX(__gm__ T __out__* out, __gm__ T __in__* src0, __gm__ T __in__* src1)
{
...
{
    (void)stream;
    runTPARTMAX<T, kRows, kCols, kValidRows1, kValidCols1>(out, src0, src1);
}

template void LaunchTPARTMAX<float, kRows, kCols, kValidRows1, kValidCols1>(
    float* out, float* src0, float* src1, void* stream);
template void LaunchTPARTMAX<int8_t, kRows, kCols, kValidRows1, kValidCols1>(
