...
template <
    typename TIdx, typename T, int kTRows, int kTCols, bool checkVal = false, int iRow = kTRows, int iCol = kTCols,
    int oRow = kTRows, int oCol = kTCols, int oVRow = oRow, int oVCol = oCol, typename LaunchFn>
