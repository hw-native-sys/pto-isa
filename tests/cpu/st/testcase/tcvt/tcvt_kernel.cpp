...
template void launchTCVT<float, int32_t, 256, 64, 256, 64, pto::SaturationMode::OFF>(
    float* dst, int32_t* src, void* stream);
template void launchTCVT<int16_t, float, 16, 32, 16, 32, pto::SaturationMode::OFF>(
    int16_t* dst, float* src, void* stream);
template void launchTCVT<int32_t, float, 32, 512, 32, 512, pto::SaturationMode::OFF>(
    int32_t* dst, float* src, void* stream);
template void launchTCVT<int32_t, int16_t, 2, 512, 2, 512, pto::SaturationMode::OFF>(
    int32_t* dst, int16_t* src, void* stream);
template void launchTCVT<int32_t, float, 4, 4096, 4, 4096, pto::SaturationMode::OFF>(
    int32_t* dst, float* src, void* stream);
template void launchTCVT<float, int16_t, 64, 64, 64, 64, pto::SaturationMode::OFF>(
    float* dst, int16_t* src, void* stream);
template void launchTCVT<aclFloat16, float, 64, 64, 64, 64, pto::SaturationMode::OFF>(
    aclFloat16* dst, float* src, void* stream);
template void launchTCVT<uint8_t, aclFloat16, 64, 64, 64, 64, pto::SaturationMode::OFF>(
    uint8_t* dst, aclFloat16* src, void* stream);
template void launchTCVT<float, int32_t, 64, 64, 64, 64, pto::SaturationMode::ON>(
    float* dst, int32_t* src, void* stream);
template void launchTCVT<float, int8_t, 128, 128, 128, 128, pto::SaturationMode::ON>(
    float* dst, int8_t* src, void* stream);
template void launchTCVT<uint8_t, float, 64, 64, 64, 64, pto::SaturationMode::ON>(
    uint8_t* dst, float* src, void* stream);
template void launchTCVT<int16_t, int32_t, 64, 64, 64, 64, pto::SaturationMode::ON>(
    int16_t* dst, int32_t* src, void* stream);
template void launchTCVT<int8_t, aclFloat16, 32, 32, 32, 32, pto::SaturationMode::ON>(
    int8_t* dst, aclFloat16* src, void* stream);
template void launchTCVT<uint8_t, aclFloat16, 64, 64, 64, 64, pto::SaturationMode::ON>(
    uint8_t* dst, aclFloat16* src, void* stream);
