...
6. [指令集（概述）](06-instructions_zh.md)
7. [编程指南](07-programming_zh.md)
8. [虚拟 ISA 与 IR](08-virtual-isa-and-ir_zh.md)
9. [字节码与工具链](09-bytecode-and-toolchain_zh.md)
10. [内存顺序与一致性](10-memory-ordering-and-consistency_zh.md)
11. [后端画像与一致性](11-backend-profiles-and-conformance_zh.md)
12. [附录 A：术语表](appendix-a-glossary_zh.md)
13. [附录 B：指令契约模板](appendix-b-instruction-contract-template_zh.md)
14. [附录 C：诊断分类](appendix-c-diagnostics-taxonomy_zh.md)
15. [附录 D：指令族矩阵](appendix-d-instruction-family-matrix_zh.md)
