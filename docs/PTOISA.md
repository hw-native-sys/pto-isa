...
| Elementwise (Tile-Tile) | [`TFUSEDMULADD`](isa/TFUSEDMULADD.md) | Elementwise ternary op: `src0 * dst + src1`. |
| Elementwise (Tile-Tile) | [`TSUBRELU`](isa/TSUBRELU.md) | Elementwise subtract then ReLU of two tiles. |
| Elementwise (Tile-Tile) | [`TFUSEDMULADDRELU`](isa/TFUSEDMULADDRELU.md) | Elementwise ternary op: `ReLU(src0 * dst + src1)`. |
...
| Complex | [`TSCATTER`](isa/TSCATTER.md) | Scatter source elements into a destination tile using per-element flattened offsets. |
| Complex | [`TQUANT`](isa/TQUANT.md) | Quantize a tile (e.g. FP32 to FP8) producing exponent/scaling/max outputs. |
| Complex | [`TADDReluConv`](isa/TADDReluConv.md) | Fused elementwise add, ReLU clamp, and type conversion: dst = convert(max(0, src0 + src1)). |
