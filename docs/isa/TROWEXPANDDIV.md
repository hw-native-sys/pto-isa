...
Row-wise broadcast divide: expand the broadcast operand, then compute `src0 / src1` elementwise.
...
- Integer division truncates toward zero; division by zero is target-defined.
