...
![TMULA tile operation](../figures/isa/TMULA.svg)
...
```text
%dst = tmula %src0, %src1 : !pto.tile<...>, !pto.tile<...>
```

### AS Level 1（SSA）

```text
%dst = pto.tmula %src0, %src1 : (!pto.tile<...>, !pto.tile<...>) -> !pto.tile<...>
```

### AS Level 2（DPS）

```text
pto.tmula ins(%src0, %src1 : !pto.tile_buf<...>, !pto.tile_buf<...>) outs(%dst : !pto.tile_buf<...>)
```
