...
Canonical tile-instruction reference: [pto.tpows](./tile/ops/tile-scalar-and-immediate/tpows.md).
...
- Canonical per-op page: [pto.tpows](./tile/ops/tile-scalar-and-immediate/tpows.md)
