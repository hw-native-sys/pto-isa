...
![TROWEXPANDDIV模式1 tile operation](../figures/isa/TROWEXPANDDIV.svg)

### 模式2—每行32字节块（RowMajor src1）

![TROWEXPANDDIV模式2 tile operation](../figures/isa/TROWEXPANDDIV_mode2.svg)
...
- `TileDataDst::DType`、`TileDataSrc0::DType`、`TileDataSrc1::DType` 必须是以下之一：`half`、`float`（适用于Atlas A2 训练系列产品/Atlas A2 推理系列产品、Atlas A3 训练系列产品/Atlas A3 推理系列产品和Ascend 950PR/Ascend 950DT）、`int16`、`int32`、`uint16`、`uint32`（仅适用于Ascend 950PR/Ascend 950DT）。
