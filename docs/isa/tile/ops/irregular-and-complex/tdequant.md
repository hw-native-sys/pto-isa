...
`pto.tdequant` is part of the [Irregular and Complex](../../irregular-and-complex.md) tile instruction family.
...
- [Irregular and Complex](../../irregular-and-complex.md)
- [pto.tquant](./tquant.md)
