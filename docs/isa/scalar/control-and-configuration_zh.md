...
- [微指令参考](./ops/micro-instruction/README_zh.md)
...
Tile 指令集的[同步与配置](../tile/sync-and-config_zh.md)页面记录 `pto.settf32mode`、`pto.setfmatrix`、`pto.set_img2col_rpt` 和 `pto.set_img2col_padding`。这些操作配置 tile-mode 状态，因此属于 Tile 指令集，不属于本标量/控制章节。
