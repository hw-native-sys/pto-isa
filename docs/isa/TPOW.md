...
Canonical tile-instruction reference: [pto.tpow](./tile/ops/elementwise-tile-tile/tpow.md).
...
- Canonical per-op page: [pto.tpow](./tile/ops/elementwise-tile-tile/tpow.md)
