...
`pto.tdequant` 属于[非 ISA 与支撑操作](../../non-isa-and-supporting-ops_zh.md)指令集。
...
- [非 ISA 与支撑操作](../../non-isa-and-supporting-ops_zh.md)
- [pto.tquant](../../../tile/ops/irregular-and-complex/tquant_zh.md)
