...
> The index is not exhaustive, and a recorded location goes stale when an assertion moves
> between headers. Search by the assertion message text first and treat `At:` as a hint.

### Compile-time checks (`static_assert`)
- **SA-0001** 1-parameter constructor is only applicable to Stride with 1 dynamic dimension. (At: `include/pto/common/pto_tile.hpp:137 (+1)`; Fix: `FIX-A01,FIX-A09`)
- **SA-0002** 2-parameter constructor is only applicable to Stride with 2 dynamic dimensions. (At: `include/pto/common/pto_tile.hpp:149 (+1)`; Fix: `FIX-A01,FIX-A09`)
- **SA-0003** 3-parameter constructor is only applicable to Stride with 3 dynamic dimensions. (At: `include/pto/common/pto_tile.hpp:162 (+1)`; Fix: `FIX-A01,FIX-A09`)
- **SA-0004** 4-parameter constructor is only applicable to Stride with 4 dynamic dimensions. (At: `include/pto/common/pto_tile.hpp:100 (+1)`; Fix: `FIX-A01,FIX-A09`)
- **SA-0005** Acc Type support int32_t or float. (At: `include/pto/npu/a5/TMatmul.hpp:121`; Fix: `-`)
- **SA-0006** BFractal_ is RowMajor and SFractal_ is NoneBox: Rows must be 32-byte aligned, \ BFractal_ is ColMa… (At: `include/pto/common/pto_tile.hpp:658`; Fix: `FIX-A04`)
...
- **SA-0022** Dst and src must be the same. (At: `include/pto/npu/a5/TSort32.hpp:181`; Fix: `-`)
...
- **SA-0055** GlobalTensor input shape now only support 2 dim, or 3 dim with Shape2 as ndNum (At: `include/pto/common/arch/register/tload_common.hpp:165`; Fix: `FIX-A09`)
- **SA-0056** GlobalTensor only support 2 dim when DN2ZN! (At: `include/pto/npu/a2a3/TLoad.hpp:333`; Fix: `FIX-A09`)
- **SA-0057** GlobalTensor only support 2 dim when ND2NZ, or 3 dim with Shape2 as ndNum! (At: `include/pto/common/arch/memory/tload_common.hpp:277`; Fix: `FIX-A09`)
...
- **SA-0068** Left Type and Right Type must be int8_t when Acc Type is int32_t. (At: `include/pto/npu/a5/TMatmul.hpp:123`; Fix: `-`)
...
- **SA-0082** now only support ND2NZ DN2NZ ND2ND DN2DN NZ2NZ DN2ZN in current platform (At: `include/pto/common/arch/register/tload_common.hpp:138`; Fix: `-`)
...
- **SA-0100** Source TileType only support Vec/Acc! (At: `include/pto/npu/a5/TStore.hpp:418`; Fix: `FIX-A08`)
- **SA-0101** Source TileType only support Vec/Acc/Mat! (At: `include/pto/npu/a2a3/TStore.hpp:525`; Fix: `FIX-A08`)
...
- **SA-0169** TFillPad, src and dst data type should be the same! (At: `include/pto/cpu/TFillPad.hpp:72`; Fix: `-`)
...
- **SA-0220** TileData only support SFractalSize = 512Bytes! (At: `include/pto/npu/a2a3/TLoad.hpp:309 (+1)`; Fix: `-`)
- **SA-0221** TileData SFractalSize must be 512 of NZ format in L1 (At: `include/pto/npu/a5/TLoad.hpp:192`; Fix: `-`)
- **SA-0222** TileData static shape must be less than 512KB in L1 (At: `include/pto/npu/a5/TLoad.hpp:187`; Fix: `FIX-A09`)
- **SA-0223** TileData::PadVal only support Null or Zero in B64 mode (At: `include/pto/npu/a5/TLoad.hpp:509`; Fix: `-`)
- **SA-0224** TileData::Rows must be less than 16384 in L1 (At: `include/pto/npu/a5/TLoad.hpp:186`; Fix: `-`)
...
- **SA-0265** TMov: When Source tile data type is half, dst tile data types must be float (At: `include/pto/npu/a2a3/TMov.hpp:30`; Fix: `-`)
...
- **SA-0282** TMrgsort: Unsupported data type! Supported types are half/float (At: `include/pto/npu/a2a3/TMrgSort.hpp:186 (+1)`; Fix: `FIX-A06`)
...
- **SA-0355** GlobalTensor Shape2 != 1 (multi-ND) is only supported for ND2NZ, not DN2NZ (At: `include/pto/common/arch/register/tload_common.hpp:169`; Fix: `FIX-A06,FIX-A09`)
- **SA-0356** GlobalTensor Shape2 != 1 (multi-ND ND2NZ) is not supported on current platform (At: `include/pto/common/arch/register/tload_common.hpp:172 (+1)`; Fix: `FIX-A06`)
- **SA-0357** multi-ND ND2NZ does not support fp4/hif4 (At: `include/pto/common/arch/register/tload_common.hpp:175`; Fix: `FIX-A06`)
- **SA-0358** multi-ND DN2ZN requires Shape0 == Shape1 == 1 (At: `include/pto/common/arch/register/tload_common.hpp:189`; Fix: `FIX-A09`)
- **SA-0359** multi-ND DN2ZN requires a 512-byte ZN fractal (At: `include/pto/common/arch/register/tload_common.hpp:192`; Fix: `FIX-A09`)
- **SA-0360** multi-ND DN2ZN only supports b8, b16 and b32, not fp4/hif4 (At: `include/pto/common/arch/register/tload_common.hpp:193`; Fix: `FIX-A06`)
- **SA-0361** multi-ND DN2ZN is not supported on current platform (At: `include/pto/common/arch/register/tload_common.hpp:196`; Fix: `FIX-A06`)
- **SA-0362** multi-ND DN2ZN destination stride must fit in 16 bits (At: `include/pto/common/arch/register/tload_common.hpp:199`; Fix: `FIX-A09`)
...
- **PA-0028** The 4th dim of DN shape must be 32-byte aligneded! (At: `include/pto/npu/a2a3/TLoad.hpp:231 (+1)`; Fix: `FIX-A09`)
- **PA-0029** The 5th dim of ND shape must be 32-byte aligneded! (At: `include/pto/npu/a2a3/TLoad.hpp:196 (+1)`; Fix: `FIX-A09`)
...
- **PA-0035** The Shape3 of GlobalTensor must be in range of [1, 16384]! (At: `include/pto/common/arch/register/tload_common.hpp:226 (+1)`; Fix: `FIX-A09`)
- **PA-0036** The Shape3 of GlobalTensor must be in range of [1, 65535]! (At: `include/pto/npu/a2a3/TLoad.hpp:340`; Fix: `FIX-A09`)
- **PA-0037** The Shape4 of GlobalTensor must be in range of [1, 16384]! (At: `include/pto/npu/a2a3/TLoad.hpp:339`; Fix: `FIX-A09`)
- **PA-0038** The Shape4 of GlobalTensor must be in range of [1, 65535]! (At: `include/pto/npu/a2a3/TLoad.hpp:313`; Fix: `FIX-A09`)
- **PA-0039** The Stride3 of GlobalTensor must be in range of [1, 65535]! (At: `include/pto/npu/a2a3/TLoad.hpp:314 (+1)`; Fix: `FIX-A09`)
...
- **PA-0065** The Shape2 (ndNum) of GlobalTensor must be in [1, 65535]! (At: `include/pto/common/arch/register/tload_common.hpp:247 (+1)`; Fix: `FIX-A09`)
- **PA-0066** The ndNum * nValue must not exceed TileData::Rows! (At: `include/pto/common/arch/memory/tload_common.hpp:314`; Fix: `FIX-A09`)
- **PA-0067** The validRow must be equal to Shape2 * Shape3 in multi-ND ND2NZ! (At: `include/pto/common/arch/memory/tload_common.hpp:315`; Fix: `FIX-A05,FIX-A09`)
- **PA-0068** The Stride2 of GlobalTensor must be in [1, 65535], it is the 16-bit srcNdMatrixStride! (At: `include/pto/common/arch/memory/tload_common.hpp:308`; Fix: `FIX-A09`)
- **PA-0069** The Shape3 * C0 must not exceed 65535, it is the 16-bit dstNzMatrixStride! (At: `include/pto/common/arch/memory/tload_common.hpp:311`; Fix: `FIX-A09`)
- **PA-0070** The validRow must be in [1, TileData::Rows]! (At: `include/pto/common/arch/register/tload_common.hpp:260`; Fix: `FIX-A05`)
- **PA-0071** The validRow must not exceed Shape2 * Shape3 in multi-ND ND2NZ! (At: `include/pto/common/arch/register/tload_common.hpp:261`; Fix: `FIX-A05,FIX-A09`)
- **PA-0072** The Shape4 of GlobalTensor must be in [1, 16384]! (At: `include/pto/common/arch/register/tload_common.hpp:250`; Fix: `FIX-A09`)
- **PA-0073** The validCol must be in [1, TileData::Cols]! (At: `include/pto/common/arch/register/tload_common.hpp:251`; Fix: `FIX-A05`)
- **PA-0074** The validCol must not exceed Shape2 * Shape4 in multi-ND DN2ZN! (At: `include/pto/common/arch/register/tload_common.hpp:252`; Fix: `FIX-A05,FIX-A09`)
- **PA-0075** The validRow must be in [1, min(TileData::Rows, Shape3)] in multi-ND DN2ZN! (At: `include/pto/common/arch/register/tload_common.hpp:255`; Fix: `FIX-A05,FIX-A09`)
- **PA-0076** The Stride3 must be 1 in multi-ND DN2ZN! (At: `include/pto/common/arch/register/tload_common.hpp:249`; Fix: `FIX-A09`)

### CPU simulator checks (`assert`)

- **CA-0001** assert (src.GetValidRow() == dst.GetValidRow() && src.GetValidCol() == dst.GetValidCol()); (At: `include/pto/cpu/TMov.hpp:23`)
- **CA-0002** assert((rowsMerged && TileData::isRowMajor) || (colsMerged && !TileData::isRowMajor) || ndIntoNzTile || partialMultiNd); (At: `include/pto/cpu/TLoad.hpp:116`)
...
- **CA-0008** assert(partialMultiNd); (At: `include/pto/cpu/TLoad.hpp:113`)
