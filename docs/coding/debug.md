...
- **PA-0065** The Shape2 (ndNum) of GlobalTensor must be in [1, 65535]! (At: `include/pto/common/arch/register/tload_common.hpp:225 (+1)`; Fix: `FIX-A09`)
...
- **PA-0070** The validRow must be in [1, TileData::Rows]! (At: `include/pto/common/arch/register/tload_common.hpp:227`; Fix: `FIX-A05`)
- **PA-0071** The validRow must not exceed Shape2 * Shape3 in multi-ND ND2NZ! (At: `include/pto/common/arch/register/tload_common.hpp:228`; Fix: `FIX-A05,FIX-A09`)
...
- **CA-0002** assert((rowsMerged && TileData::isRowMajor) || (colsMerged && !TileData::isRowMajor) || ndIntoNzTile || partialMultiNd); (At: `include/pto/cpu/TLoad.hpp:101`)
