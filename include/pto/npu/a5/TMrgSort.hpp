...
__tf__ AICORE void TMrgsort(
    ...
    typename Src2TileData::TileDType __in__ src2, typename Src3TileData::TileDType __in__ src3, uint16_t& mrgSortList0,
    uint16_t& mrgSortList1, uint16_t& mrgSortList2, uint16_t& mrgSortList3, unsigned dstCol, unsigned src0Col,
