...
__tf__ PTO_INTERNAL OP_NAME(TROWEXPANDSUB) OP_TYPE(broadcast) void TRowExpandSub(
    ...
    unsigned version = VFImplKind::VFIMPL_DEFAULT)
{
    ...
    if (src0eqdst) {
        ...
        RowExpandBinaryInstr<
            RowExpandSubOp2<T>, TileDataDst, TileDataSrc0, TileDataSrc1, elementsPerRepeat, blockSizeElem>(
            dstPtr, src0Ptr, src1Ptr, validRow, validCol);
    }
}
...
PTO_INTERNAL void TROWEXPANDSUB_IMPL(
