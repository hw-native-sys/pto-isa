...
PTO_INTERNAL void histogram_b8i_b32o(
    vector_u8& vb8_src, vector_u16& vb16_bin_n0, vector_u16& vb16_bin_n1, vector_u32& vb32_bin_n0_even_inc,
    vector_u32& vb32_bin_n0_odd_inc, vector_u32& vb32_bin_n1_even_inc, vector_u32& vb32_bin_n1_odd_inc,
    vector_bool& preg_b8_0, vector_bool& preg_b8_1, vector_bool& preg_b16, vector_bool& preg_b32)
{
...
__tf__ PTO_INTERNAL void THistogram(
    typename TileDst::TileDType __out__ bin_count, typename TileSrc::TileDType __in__ scores,
    ...
    __VEC_SCOPE__
    {
        ...
        for (uint16_t r = 0; r < (uint16_t)validRows; ++r) {
            ...
            for (uint16_t c = 0; c < (uint16_t)repeatTimesPerRow; ++c) {
                ...
                vlds(
                    (vector_u8&)vb8_src_LSB, (vector_u8&)vb8_src_MSB, (__ubuf__ uint8_t*&)srcPtr,
                    Type_coeff * (r * TileSrc::Cols + c * ElemPerRepeatB8), DINTLV_B8);
                if constexpr (isMSB) {
                    histogram_b8i_b32o(
                        vb8_src_MSB, vb16_BIN_N0, vb16_BIN_N1, (vector_u32&)vb32_BIN_N0_even,
                        (vector_u32&)vb32_BIN_N0_odd, (vector_u32&)vb32_BIN_N1_even, (vector_u32&)vb32_BIN_N1_odd,
                        preg_b8_0, preg_b8_1, preg_all_b16, preg_all_b32);
                } else {
                    vcmp_eq(preg_idx, (vector_u8&)vb8_src_MSB, vb8_idx, preg_b8_0);
                    histogram_b8i_b32o(
                        vb8_src_LSB, vb16_BIN_N0, vb16_BIN_N1, (vector_u32&)vb32_BIN_N0_even,
                        (vector_u32&)vb32_BIN_N0_odd, (vector_u32&)vb32_BIN_N1_even, (vector_u32&)vb32_BIN_N1_odd,
                        preg_idx, preg_idx, preg_all_b16, preg_all_b32);
                }
            }
            vsts(
                (vector_u32&)vb32_BIN_N0_even, (vector_u32&)vb32_BIN_N0_odd, (__ubuf__ uint32_t*&)dstPtr, 256 * r,
                INTLV_B32, preg_all_b32);
            vsts(
                (vector_u32&)vb32_BIN_N1_even, (vector_u32&)vb32_BIN_N1_odd, (__ubuf__ uint32_t*&)dstPtr128ElemShift,
...
PTO_INTERNAL void deintlv_u32_bytes(
    __ubuf__ uint32_t* srcPtr, unsigned elemOffset, vector_u8& byte0, vector_u8& byte1, vector_u8& byte2,
    vector_u8& byte3)
{
...
PTO_INTERNAL void load_filter_indices(
    __ubuf__ uint8_t* idxPtr, unsigned idxCols, vector_u8& idx0, vector_u8& idx1, vector_u8& idx2)
{
...
template <HistByte byte>
PTO_INTERNAL void filter_and_histogram_u32(
    vector_u8& byte0, vector_u8& byte1, vector_u8& byte2, vector_u8& byte3, vector_u8& idx0, vector_u8& idx1,
    vector_u8& idx2, vector_u16& vb16_N0, vector_u16& vb16_N1, vector_u32& vb32_N0_even, vector_u32& vb32_N0_odd,
    vector_u32& vb32_N1_even, vector_u32& vb32_N1_odd, vector_bool& preg0, vector_bool& preg1, vector_bool& preg_b16,
    vector_bool& preg_b32)
{
    if constexpr (byte == HistByte::BYTE_3) {
        histogram_b8i_b32o(
            byte3, vb16_N0, vb16_N1, vb32_N0_even, vb32_N0_odd, vb32_N1_even, vb32_N1_odd, preg0, preg1, preg_b16,
            preg_b32);
    } else {
        vector_bool filt;
        ...
        if constexpr (byte == HistByte::BYTE_2) {
            histogram_b8i_b32o(
                byte2, vb16_N0, vb16_N1, vb32_N0_even, vb32_N0_odd, vb32_N1_even, vb32_N1_odd, filt, filt, preg_b16,
                preg_b32);
        } else if constexpr (byte == HistByte::BYTE_1) {
            histogram_b8i_b32o(
                byte1, vb16_N0, vb16_N1, vb32_N0_even, vb32_N0_odd, vb32_N1_even, vb32_N1_odd, filt, filt, preg_b16,
                preg_b32);
        } else {
            histogram_b8i_b32o(
                byte0, vb16_N0, vb16_N1, vb32_N0_even, vb32_N0_odd, vb32_N1_even, vb32_N1_odd, filt, filt, preg_b16,
                preg_b32);
        }
    }
}
...
__tf__ PTO_INTERNAL void THistogramU32(
    typename TileDst::TileDType __out__ bin_count, typename TileSrc::TileDType __in__ scores,
    typename TileIdx::TileDType __in__ idx, unsigned validRows, unsigned validCols)
{
    __ubuf__ typename TileDst::DType* dstPtr = (__ubuf__ typename TileDst::DType*)__cce_get_tile_ptr(bin_count);
    ...
    __VEC_SCOPE__
    {
        ...
        for (uint16_t r = 0; r < (uint16_t)validRows; ++r) {
            ...
            for (uint16_t c = 0; c < (uint16_t)repeatTimesPerRow; ++c) {
                ...
                vector_bool preg_b8_1 = CreatePredicate<uint8_t>(sreg_odd);
                deintlv_u32_bytes(
                    (__ubuf__ uint32_t*)srcPtr, r * TileSrc::Cols + c * ElemPerRepeatB8, vb8_byte0, vb8_byte1,
                    vb8_byte2, vb8_byte3);
                filter_and_histogram_u32<byte>(
                    vb8_byte0, vb8_byte1, vb8_byte2, vb8_byte3, vb8_idx0, vb8_idx1, vb8_idx2, vb16_BIN_N0, vb16_BIN_N1,
                    vb32_BIN_N0_even, vb32_BIN_N0_odd, vb32_BIN_N1_even, vb32_BIN_N1_odd, preg_b8_0, preg_b8_1,
            ...
            vsts(
                ...
                INTLV_B32, preg_all_b32);
            vsts(
                (vector_u32&)vb32_BIN_N1_even, (vector_u32&)vb32_BIN_N1_odd, (__ubuf__ uint32_t*&)dstPtr128, 256 * r,
                INTLV_B32, preg_all_b32);
        }
    }
}
...
PTO_INTERNAL void THISTOGRAM_IMPL(TileDst& dst, TileSrc& src, TileIdx& idx)
{
    ...
    static_assert(
        std::is_same<SrcT, uint16_t>::value || std::is_same<SrcT, uint32_t>::value,
    ...
    if constexpr (std::is_same<SrcT, uint16_t>::value) {
        ...
        static_assert(
            (!TileIdx::isBoxedLayout && !TileIdx::isRowMajor && TileIdx::Cols == 1),
        ...
        THistogram<TileDst, TileSrc, TileIdx, isMSB>(
            dst.data(), src.data(), idx.data(), src.GetValidRow(), src.GetValidCol());
    } else {
        ...
        THistogramU32<byte, TileDst, TileSrc, TileIdx>(
            dst.data(), src.data(), idx.data(), src.GetValidRow(), src.GetValidCol());
    }
}
