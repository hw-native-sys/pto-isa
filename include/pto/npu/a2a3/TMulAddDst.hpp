...
struct MulAddDstOp {
    ...
    {
        vmla(dst, src0, src1, repeats, 1, 1, 1, dstRepeatStride, src0RepeatStride, src1RepeatStride);
    }
};
...
__tf__ PTO_INTERNAL void TMulAddDst(typename TileDataDst::TileDType __in__ __out__ dst,
