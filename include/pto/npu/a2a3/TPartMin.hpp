...
__tf__ PTO_INTERNAL void TPartMin(
    ...
    unsigned src1ValidCol, unsigned dstValidRow, unsigned dstValidCol)
{
    ...
    if (condSrc0EqDst) {
        TPartInstr<
            PartMinOp<T>, T, dstCol, src0Col, dstRow, elementsPerRepeat, blockSizeElem, dstRowStride, src0RowStride,
            src1RowStride>(
            dstPtr, src0Ptr, src1Ptr, src0ValidRow, src0ValidCol, src1ValidRow, src1ValidCol, dstValidRow, dstValidCol);
    } else if (condSrc1EqDst) {
        TPartInstr<
            PartMinOp<T>, T, dstCol, src1Col, dstRow, elementsPerRepeat, blockSizeElem, dstRowStride, src1RowStride,
            src0RowStride>(
