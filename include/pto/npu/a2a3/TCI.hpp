...
PTO_INTERNAL void CheckValid()
{
    ...
    static_assert(
        (sizeof(typename TileData::DType) == 4 || (sizeof(typename TileData::DType) == 2)),
...
template <typename TileData, typename TileDataTmp, typename T, int descending>
__tf__ AICORE void TCI_b32_normal(
    typename TileData::TileDType __out__ dst, typename TileDataTmp::TileDType __in__ tmp, T S, unsigned validCol,
    unsigned numRepeatPerLine, unsigned numRemainPerLine)
{
    __ubuf__ typename TileData::DType* dstPtr = (__ubuf__ typename TileData::DType*)__cce_get_tile_ptr(dst);
...
template <typename TileData, typename TileDataTmp, typename T, int descending>
__tf__ AICORE void TCI_b16_repeat(
    typename TileData::TileDType __out__ dst, typename TileDataTmp::TileDType __in__ tmp, T S, unsigned validCol,
    unsigned numRepeatPerLine, unsigned numRemainPerLine)
{
    __ubuf__ typename TileData::DType* dstPtr = (__ubuf__ typename TileData::DType*)__cce_get_tile_ptr(dst);
...
template <typename TileData, typename TileDataTmp, typename T, int descending>
__tf__ AICORE void TCI_b16_normal(
    typename TileData::TileDType __out__ dst, typename TileDataTmp::TileDType __in__ tmp, T S, unsigned validCol,
    unsigned numRepeatPerLine, unsigned numRemainPerLine)
{
    __ubuf__ typename TileData::DType* dstPtr = (__ubuf__ typename TileData::DType*)__cce_get_tile_ptr(dst);
